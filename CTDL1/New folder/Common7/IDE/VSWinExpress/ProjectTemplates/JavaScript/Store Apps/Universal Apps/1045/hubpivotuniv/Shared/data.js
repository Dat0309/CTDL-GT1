(function () {
    ...
    // TODO: Zamień dane na swoje rzeczywiste dane.
    // Możesz dodawać dane z asynchronicznych źródeł, kiedy tylko staną się dostępne.
    ...
    // Uzyskaj odwołanie do elementu, za pomocą klucza grupy i tytułu elementu, jako
    // unikatowe odwołanie do elementu, który można łatwo serializować.
    function getItemReference(item) {
        return [item.group.key, item.title];
    }

    // Ta funkcja zwraca obiekt WinJS.Binding.List, zawierający tylko elementy,
    // które należą do wprowadzonej grupy.
    function getItemsFromGroup(group) {
        return list.createFiltered(function (item) { return item.group.key === group.key; });
    }

    // Pobierz unikatową grupę odpowiadającą podanemu kluczowi grupy.
    function resolveGroupReference(key) {
        return groupedItems.groups.getItemFromKey(key).data;
    }

    // Pobierz unikatowy element z dostarczonej tablicy ciągów, która powinna zawierać
    // klucz grupy oraz tytuł elementu.
    ...
    // Zwraca tablicę przykładowych danych, które można dodać do
    // listy danych aplikacji. 
    function generateSampleData() {
        ...
        // Te trzy ciągi kodują obrazy zastępcze. Możesz ustawić
        // właściwość backgroundImage w Twoich danych rzeczywistych na adresy URL obrazów.
        var darkGray = "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAAAXNSR0IArs4c6QAAAARnQU1BAACxjwv8YQUAAAAJcEhZcwAADsQAAA7EAZUrDhsAAAANSURBVBhXY3B0cPoPAANMAcOba1BlAAAAAElFTkSuQmCC";
        var lightGray = "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAAAXNSR0IArs4c6QAAAARnQU1BAACxjwv8YQUAAAAJcEhZcwAADsQAAA7EAZUrDhsAAAANSURBVBhXY7h4+cp/AAhpA3h+ANDKAAAAAElFTkSuQmCC";
        var mediumGray = "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAAAXNSR0IArs4c6QAAAARnQU1BAACxjwv8YQUAAAAJcEhZcwAADsQAAA7EAZUrDhsAAAANSURBVBhXY5g8dcZ/AAY/AsAlWFQ+AAAAAElFTkSuQmCC";

        // Każda z tych przykładowych grup musi mieć unikatowy klucz do wyświetlenia
        // oddzielnie.
        var sampleGroups = [
        ...
        // Każdy z tych przykładowych elementów powinien mieć odwołanie do określonej
        // grupy.
        var sampleItems = [
