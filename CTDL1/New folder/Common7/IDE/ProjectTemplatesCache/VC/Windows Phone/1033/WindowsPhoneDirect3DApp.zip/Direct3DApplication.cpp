...
void $safeprojectname$::SetWindow(CoreWindow^ window)
{
	...
	window->PointerReleased +=
		ref new TypedEventHandler<CoreWindow^, PointerEventArgs^>(this, &$safeprojectname$::OnPointerReleased);
...
void $safeprojectname$::OnPointerReleased(CoreWindow^ sender, PointerEventArgs^ args)
{
	// Insert your code here.
}
