...
namespace $ext_safeprojectname$
{
	...
	public:
		...
		/// </summary>
		property $ext_safeprojectname$::Common::NavigationHelper^ NavigationHelper
		{
			$ext_safeprojectname$::Common::NavigationHelper^ get();
		}
	...
	private:
		...
		void LoadState(Platform::Object^ sender, $ext_safeprojectname$::Common::LoadStateEventArgs^ e);
