(function () {
    ...
    // TODO: Nahradit data skutečnými daty.
    // Můžete přidat data z asynchronních zdrojů kdykoliv budou k dispozici.
    ...
    // Získat odkaz na položku pomocí klíče skupiny a názvu položky jako
    // jedinečný odkaz na položku, kterou lze snadno serializovat.
    function getItemReference(item) {
        return [item.group.key, item.title];
    }

    // Tato funkce vrací WinJS.Binding.List, obsahující pouze položky,
    // které patří do zadané skupiny.
    function getItemsFromGroup(group) {
        return list.createFiltered(function (item) { return item.group.key === group.key; });
    }

    // Získejte jedinečnou skupinu odpovídající zadanému klíči skupiny.
    function resolveGroupReference(key) {
        return groupedItems.groups.getItemFromKey(key).data;
    }

    // Získejte jedinečnou položku ze zadané řady řetězců, které by měly obsahovat
    // klíč skupiny a název položky.
    ...
    // Vrací řadu vzorových dat, která lze přidat k seznamu dat
    // aplikace. 
    function generateSampleData() {
        ...
        // Tyto tři řetězce kódují zástupné obrázky. Budete chtít nastavit
        // vlastnost backgroundImage ve skutečných datech na adresy URL obrazků.
        var darkGray = "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAAAXNSR0IArs4c6QAAAARnQU1BAACxjwv8YQUAAAAJcEhZcwAADsQAAA7EAZUrDhsAAAANSURBVBhXY3B0cPoPAANMAcOba1BlAAAAAElFTkSuQmCC";
        var lightGray = "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAAAXNSR0IArs4c6QAAAARnQU1BAACxjwv8YQUAAAAJcEhZcwAADsQAAA7EAZUrDhsAAAANSURBVBhXY7h4+cp/AAhpA3h+ANDKAAAAAElFTkSuQmCC";
        var mediumGray = "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAAAXNSR0IArs4c6QAAAARnQU1BAACxjwv8YQUAAAAJcEhZcwAADsQAAA7EAZUrDhsAAAANSURBVBhXY5g8dcZ/AAY/AsAlWFQ+AAAAAElFTkSuQmCC";

        // Každý z těchto vzorků skupin musí mít jedinečný klíč pro zobrazení
        // samostatně.
        var sampleGroups = [
        ...
        // Každý z těchto vzorků položek by měl odkazovat na určitou
        // skupinu.
        var sampleItems = [
