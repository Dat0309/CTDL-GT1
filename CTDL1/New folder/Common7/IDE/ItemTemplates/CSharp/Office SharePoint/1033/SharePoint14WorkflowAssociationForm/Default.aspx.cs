...
namespace $rootnamespace$
{
    public partial class $safeitemrootname$: LayoutsPageBase
    {
        ...
        private string historyListDescription = "$loc_HistoryListDescription$";
        private string taskListDescription = "$loc_TaskListDescription$";
        private string listCreationFailed = "$loc_ListCreationError$";
        private string workflowAssociationFailed = "$loc_AssociationFailedError$";
