        ...
        (function (DiagnosticsHub) {
            ...
            var DiagnosticsHubNativeHost = (function () {
                ...
                DiagnosticsHubNativeHost.prototype.request = function (controllerId, actionId, sessionId, request) {
                    ...
                    var result = null;
                    if(this._externalObject) {
                        result = this._externalObject.request(controllerId, actionId, sessionId, (typeof request === "string") ? request : (request !== null && (typeof request !== "undefined")) ? JSON.stringify(request) : "", function (jsonResponse) {
                    ...
                    if(response.hresult !== 0) {
                        this._logger.error("Could not invoke request method of native host: " + result);
                        var error = new Error();
                        error.message = error.name = response.hresult.toString(16);
                        return Plugin.Promise.wrapError(error);
                    } else {
                        var oncancel = function () {
                            if(_this._externalObject && _this._externalObject.cancel) {
                                _this._externalObject.cancel(response.requestId);
                            }
                        };
                        return new Plugin.Promise(promiseInitialization, oncancel.bind(this));
                    }
                };
        ...
        (function (DiagnosticsHub) {
            (function (DataWarehouse) {
                ...
                var DataSourceIdentity = (function () {
                    ...
                    DataSourceIdentity.DiagnosticsPackage = "DiagnosticsHub.Resource.DiagnosticsPackage";
                    DataSourceIdentity.EtlFile = "DiagnosticsHub.Resource.EtlFile";
                    DataSourceIdentity.JavaScriptSource = "DiagnosticsHub.Resource.JavaScript.SourceDirectory";
                    DataSourceIdentity.SymbolCache = "DiagnosticsHub.Resource.SymbolCache";
                    DataSourceIdentity.UnknownFile = "DiagnosticsHub.Resource.File";
                    DataSourceIdentity.UnknownDirectory = "DiagnosticsHub.Resource.Directory";
            ...
            (function (DataWarehouse) {
                ...
                var DataWarehouseInstance = (function () {
                    ...
                    DataWarehouseInstance.prototype.beginInitialization = function () {
                        return this._controller.request(Constants.ACTION_DATAWAREHOUSE_BEGININITIALIZATION);
                    };
...
// SIG // AAIBAAIBAAIBADAhMAkGBSsOAwIaBQAEFC+8GgRmE6pq
// SIG // k3Y+YEkxjwcjyKQxoIIVgjCCBMMwggOroAMCAQICEzMA
...
// SIG // BgEEAYI3AgEVMCMGCSqGSIb3DQEJBDEWBBSITCfQfbSM
// SIG // oJl6ET8l745JwqGMajCBmgYKKwYBBAGCNwIBDDGBizCB
// SIG // iKBugGwARABpAGEAZwBuAG8AcwB0AGkAYwBzAEgAdQBi
// SIG // AF8AMgA1ADQAMQBkADUAMgA0AC0AMQBjADIAZAAtADQA
// SIG // ZgBhADMALQA4ADYANwBiAC0ANgAxADcAYQBhADkANABi
// SIG // AGIAZgAyAGUALgBqAHOhFoAUaHR0cDovL21pY3Jvc29m
// SIG // dC5jb20wDQYJKoZIhvcNAQEBBQAEggEABJ1hof/SrehJ
// SIG // S7PXs0+V7Byuy4jPtDfugcAbfP6DdAgR1o5W5GUX2DVy
// SIG // bAjwx0LQ2pOqRk1vaScRCy/nGJgB9VTO44kVqp9vUSVg
// SIG // LJCQM71BveJ3ppfI8aoMg0IQTtggS4JdzOxAuF5ZeJYS
// SIG // GOj7+45TwnH8BdhePEXq3xSWt+SUeRHgyxSDNVqrnqTj
// SIG // NsYJBu5PA6iav85sl39isQ3jFKb5eVX5+hkNmJwBPHpQ
// SIG // 3KTv6HDj7uGqsyipJSUMAJVgtXGcs+Qqd5Fyjnz3ASHm
// SIG // CE7yzqjZXPOpNLxyt8mcfJ0m2752gSrkPYjTlUglpv0T
// SIG // DTQ/B8W4ZfdHZPBdZh0E8KGCAigwggIkBgkqhkiG9w0B
// SIG // CQYxggIVMIICEQIBATCBjjB3MQswCQYDVQQGEwJVUzET
// SIG // MBEGA1UECBMKV2FzaGluZ3RvbjEQMA4GA1UEBxMHUmVk
// SIG // bW9uZDEeMBwGA1UEChMVTWljcm9zb2Z0IENvcnBvcmF0
// SIG // aW9uMSEwHwYDVQQDExhNaWNyb3NvZnQgVGltZS1TdGFt
// SIG // cCBQQ0ECEzMAAABxsy6Ka4KqH04AAAAAAHEwCQYFKw4D
// SIG // AhoFAKBdMBgGCSqGSIb3DQEJAzELBgkqhkiG9w0BBwEw
// SIG // HAYJKoZIhvcNAQkFMQ8XDTE1MDYyOTA0MzM1MVowIwYJ
// SIG // KoZIhvcNAQkEMRYEFM6Fo/jqSHrLTFBUEvza6ctyE/8a
// SIG // MA0GCSqGSIb3DQEBBQUABIIBAESyx4ScDQZtQFWRsbnn
// SIG // JxSl/Gha49ZoZDb7EZypcsPvONB/1npF+2e3XASN8Tdo
// SIG // PRKOuILXLnHEP+MlpGlikOG4I7Q3sN6Q/4M2Z55yX7Od
// SIG // bAloSVef7uFzwIPkb4igqq3reOQGRkyyjg7HvZaQDLaa
// SIG // LFtYTjU21kpORSzD5qcjDypFdIch62in7CjeIbQjDc9a
// SIG // xs2ZkVsxFFP3HsO1veuRTQj7mFvRFWbUDClJy0U7ryki
// SIG // X/8AnW28YnP2/Se0E2i7dFUU8r6wAuP0tnyizKoGt+//
// SIG // A0mAxsMWpzhROafpYs1bBpFs4vB+pZXVkGtO9BFJBVDz
// SIG // lyvahdUWjs8xPjM=
