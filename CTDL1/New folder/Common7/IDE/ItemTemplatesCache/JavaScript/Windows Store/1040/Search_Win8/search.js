// Per un'introduzione al modello Cerca contratto, vedere la seguente documentazione:
// http://go.microsoft.com/fwlink/?LinkId=232512

// TODO: aggiungere il seguente tag di script all'intestazione della pagina di avvio per
// sottoscrivere la ricerca di eventi di contratto.
//  
    ...
    ui.Pages.define(searchPageURI, {
        ...
        _initializeLayout: function (listView, viewState) {
            ...
            if (viewState === appViewState.snapped) {
                ...
                document.querySelector(".titlearea .pagetitle").textContent = "Nome applicazione";
                document.querySelector(".titlearea .pagesubtitle").textContent = "Risultati per “" + this._lastSearch + '”';
            }
        },
