...
(function () {
    ...
    WinJS.UI.Pages.define("/$wizardrelativeurl$.html", {
        ...
        _initializeLayout: function (element) {
            // TODO: remplacez "App Name" par le nom de votre application.
            element.querySelector(".titlearea .pagetitle").textContent = "Nom de l'application";
            element.querySelector(".titlearea .pagesubtitle").textContent = "Résultats pour “" + this._lastSearch + '”';
        },
