// Úvod do šablony kontraktu Sdílení najdete v následující dokumentaci:
    ...
    app.onactivated = function (args) {
        ...
        if (args.detail.kind === Windows.ApplicationModel.Activation.ActivationKind.shareTarget) {
            ...
            if (thumbnail) {
                ...
                // Pokud neexistuje žádná miniatura, rozbalit prvky s popisem
                // a názvem pro vyplnění nevyužitého místa.
