// Pro úvod do šablony Kontraktu hledání, viz následující dokumentace:
// http://go.microsoft.com/fwlink/?LinkId=232512

// TODO: Přidat následující značky skriptu do záhlaví úvodní stránky pro
// přihlášení k událostem kontraktu hledání.
//  
    ...
    ui.Pages.define(searchPageURI, {
        ...
        _initializeLayout: function (listView, viewState) {
            ...
            if (viewState === appViewState.snapped) {
                ...
                document.querySelector(".titlearea .pagetitle").textContent = "Název aplikace";
                document.querySelector(".titlearea .pagesubtitle").textContent = "Výsledky pro “" + this._lastSearch + '”';
            }
        },
