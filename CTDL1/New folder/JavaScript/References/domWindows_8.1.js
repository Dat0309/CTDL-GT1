...
(function () {
    ...
    function getEventObject(type, attach, obj, ignoreCase) {
        function _eventTypeToObject(type, attach) {
			...
			switch (type) {
				...
				case 'MSWebViewLongRunningScriptDetected':
					return LongRunningScriptDetectedEvent;
				case 'message':
					return MessageEvent;
				case 'click':
				case 'contextmenu':
				...
				case 'MSWebViewFrameNavigationCompleted':
				case 'MSWebViewNavigationCompleted':
					return NavigationCompletedEvent;
				case 'MSWebViewContentLoading':
				case 'MSWebViewDOMContentLoaded':
				case 'MSWebViewFrameContentLoading':
				case 'MSWebViewFrameDOMContentLoaded':
				case 'MSWebViewFrameNavigationStarting':
				case 'MSWebViewNavigationStarting':
				...
				case 'MSWebViewScriptNotify':
					return ScriptNotifyEvent;
				case 'storage':
				case 'storagecommit':
					return StorageEvent;
				case 'SVGZoom':
				...
				case 'select':
					return UIEvent;
				case 'MSWebViewUnviewableContentIdentified':
					return UnviewableContentIdentifiedEvent;
				case 'wheel':
					return WheelEvent;
			};
            return MSEventObj;
	...
	var UnviewableContentIdentifiedEvent = _$inherit(NavigationEvent);
	...
	_events(HTMLVideoElement, "onMSVideoFrameStepCompleted", "onMSVideoOptimalLayoutChanged", "onMSVideoFormatChanged");
	...
	_$implement(MSWebViewAsyncOperation, EventTarget);
	...
	_events(MSWindowExtensions, "onmouseleave", "onmouseenter", "onfocusout", "onfocusin");
	...
	HTMLCanvasElement.getContext = function(contextId, args) { 
		...
		/// <returns type='Object'/>
		/// </signature>
		switch (contextId) { case "2d": return CanvasRenderingContext2D; case "experimental-webgl": return WebGLRenderingContext; default: return null; }
	};
	...
	WebGLContextAttributes.premultipliedAlpha = false;
	WebGLContextAttributes.antialias = false;
	WebGLContextAttributes.stencil = false;
	WebGLContextAttributes.depth = false;
	...
	UnviewableContentIdentifiedEvent.referrer = '';
	...
	_publicInterface('WebGLRenderingContext', {
		'DEPTH_FUNC' : 0x0B74,
	...
	_publicInterface('OES_standard_derivatives', {
	...
	_publicInterface('WebGLContextAttributes', {}, WebGLContextAttributes);
	...
	_publicInterface('EXT_texture_filter_anisotropic', {
	...
	_publicInterface('WEBGL_compressed_texture_s3tc', {
	...
	_publicInterface('MSWebViewAsyncOperation', {
		'ERROR' : 2,
		'TYPE_CREATE_DATA_PACKAGE_FROM_SELECTION' : 2,
		'TYPE_INVOKE_SCRIPT' : 1,
		'COMPLETED' : 1,
		'TYPE_CAPTURE_PREVIEW_TO_RANDOM_ACCESS_STREAM' : 0,
		'STARTED' : 0
...
// SIG // AAIBAAIBAAIBADAhMAkGBSsOAwIaBQAE