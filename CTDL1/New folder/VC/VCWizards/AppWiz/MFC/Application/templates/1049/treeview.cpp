...
// [!output TREE_VIEW_IMPL] : реализация класса [!output TREE_VIEW_CLASS]
//
...
// создание/уничтожение [!output TREE_VIEW_CLASS]
...
// диагностика [!output TREE_VIEW_CLASS]
...
[!output DOC_CLASS]* [!output TREE_VIEW_CLASS]::GetDocument() // встроена неотлаженная версия
{
...
// обработчики сообщений [!output TREE_VIEW_CLASS]
