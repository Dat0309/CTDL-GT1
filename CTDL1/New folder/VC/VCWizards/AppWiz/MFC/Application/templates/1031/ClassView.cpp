...
int CClassView::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
	...
	{
		TRACE0("Fehler beim Erstellen der Klassenansicht.\n");
		return -1;      // Fehler beim Erstellen
	}

	// Bilder laden:
	m_wndToolBar.Create(this, AFX_DEFAULT_TOOLBAR_STYLE, IDR_SORT);
	m_wndToolBar.LoadToolBar(IDR_SORT, 0, 0, TRUE /* Ist gesperrt */);
...
{
	HTREEITEM hRoot = m_wndClassView.InsertItem(_T("FakeApp-Klassen"), 0, 0);
...
{
	AfxMessageBox(_T("Memberfunktion hinzufügen..."));
}
...
void CClassView::OnChangeVisualStyle()
{
	...
	m_wndToolBar.LoadBitmap(theApp.m_bHiColorIcons ? IDB_SORT_24 : IDR_SORT, 0, 0, TRUE /* Gesperrt */);
}
