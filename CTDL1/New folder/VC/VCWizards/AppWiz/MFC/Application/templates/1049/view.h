...
// [!output VIEW_HEADER] : интерфейс класса [!output VIEW_CLASS]
//
...
[!if CONTAINER || CONTAINER_SERVER]
[!if !RICH_EDIT_VIEW]
	// m_pSelection захватывает выделенную область в текущий [!output CONTAINER_ITEM_CLASS].
	...
	//  выделения объектов, которые не являются объектами [!output CONTAINER_ITEM_CLASS].  Данный способ выделения
...
#ifndef _DEBUG  // отладочная версия в [!output VIEW_IMPL]
