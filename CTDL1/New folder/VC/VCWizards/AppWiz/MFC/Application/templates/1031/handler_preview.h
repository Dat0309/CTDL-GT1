// PreviewHandler.h : Deklaration des Vorschauhandlers
...
protected:
	...
	{
		// Erstellen Sie hier Ihr eigenes Vorschausteuerelement.
...
public:
	virtual HRESULT InitializeDocumentPreview(HWND hWndParent, RECT* prc)
	{
		...
		if (pCtrl == NULL)
		{
			ATLTRACE2(atlTraceGeneral, 4, L"InitializeDocumentPreview: Der Zeiger auf das Vorschausteuerelement ist NULL.\n");
			return E_POINTER;
		}
		...
		if (m_pDocument == NULL) 
		{
			ATLTRACE2(atlTraceGeneral, 4, L"InitializeDocumentPreview: Der Zeiger auf das Dokument ist NULL.\n");
			return E_POINTER;
		}
		...
		{
			ATLTRACE2(atlTraceGeneral, 4, L"InitializeDocumentPreview: Fehler bei der Erstellung des Vorschausteuerelements. Fehlercode: %d\n", GetLastError());
			return E_FAIL;
		}
		return S_OK;
	}
