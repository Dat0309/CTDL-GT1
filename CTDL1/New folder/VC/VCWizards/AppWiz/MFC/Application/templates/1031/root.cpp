...
// Diese ID wurde als statistisch eindeutig für Ihre Anwendung generiert.
// Sie können sie ändern, wenn Sie eine bestimmte ID bevorzugen.
...
[!if TOOLBAR_EXTCHAR_TRANSLATE]
	...
	// Erweiterte Zeichen als Menüzugriffstasten zulassen
...
[!if APP_TYPE_SDI]
	...
	if (pFrameWnd != NULL)
	{
		...
		// und Löschen. Danach führen Sie die folgende if-Anweisung aus,
