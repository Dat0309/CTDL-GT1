...
// Hinweis: Wir stellen Unterstützung für IID_I[!output SAFE_PROJECT_IDENTIFIER_NAME] zur Verfügung, um typsicheres Binden
...
[!if PROJECT_STYLE_EXPLORER]
		...
		GetNextView(pos);  // Strukturansicht überspringen
...
{
[!if EDIT_VIEW]
	// CEditView enthält ein Bearbeitungssteuerelement, das die Serialisierung automatisch erledigt
	if (!m_viewList.IsEmpty())
	{
[!if PROJECT_STYLE_EXPLORER]
		POSITION pos = GetFirstViewPosition();
...
[!else]
	...
	// Verwendet den gesamten Inhalt der Textdatei als Suchinhalt.
