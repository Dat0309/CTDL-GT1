...
[!if MENUBAR_TOOLBAR]
	...
	{
		TRACE0("Impossibile creare la barra dei menu.\n");
...
[!if ADV_DOCKING_NAVIGATION]
	...
	// Il riquadro di navigazione verrà creato sulla sinistra, quindi disabilitare temporaneamente l'ancoraggio sul lato sinistro:
	EnableDocking(CBRS_ALIGN_TOP | CBRS_ALIGN_BOTTOM | CBRS_ALIGN_RIGHT);

	// Creare e impostare la barra di navigazione di "Outlook":
	if (!CreateOutlookBar(m_wndNavigationBar, ID_VIEW_NAVIGATION, m_wndTree, m_wndCalendar, 250))
	{
		TRACE0("Impossibile creare il riquadro di navigazione.\n");
		return -1;      // impossibile creare
	}
[!endif]
[!if ADV_DOCKING_CAPTION]
	...
	if (!CreateCaptionBar())
	{
		TRACE0("Impossibile creare la barra del titolo.\n");
		return -1;      // impossibile creare
	}
[!endif]
[!if ADV_DOCKING_NAVIGATION]

	// La barra di Outlook viene creata e l'ancoraggio deve essere consentito sul lato sinistro.
...
[!endif]
	...
	{
		TRACE0("Impossibile creare le finestre di ancoraggio.\n");
		return -1;
	}
...
[!endif]
[!else]
	// impostare il gestore visualizzazione e lo stile di visualizzazione sulla base del valore persistente.
...
[!if ADV_DOCKING_EXPLORER]
	...
	{
		TRACE0("Impossibile creare la finestra Visualizzazione classi.\n");
	...
	{
		TRACE0("Impossibile creare la finestra Visualizzazione file.\n");
		return FALSE; // impossibile creare
	}
...
[!if ADV_DOCKING_PROPERTIES]
	...
	{
		TRACE0("Impossibile creare la finestra delle proprietà.\n");
		return FALSE; // impossibile creare
	}
...
BOOL [!output MAIN_FRAME_CLASS]::CreateOutlookBar(CMFCOutlookBar& bar, UINT uiID, CMFCShellTreeCtrl& tree, CCalendarBar& calendar, int nInitialWidth)
{
	...
	// float permesso, nascondi automaticamente permesso, ridimensiona permesso, CHIUDI NON PERMESSO
...
void [!output MAIN_FRAME_CLASS]::OnUpdateViewStyles(CCmdUI* pCmdUI)
{
	...
	// se il riquadro destro non è stato creato o non è una visualizzazione,
	// disabilitare i comandi nell'intervallo.
...
{
	// Mostrare o attivare il riquadro a seconda dello stato corrente.  Il
	// riquadro può essere chiuso solo tramite il pulsante [x] sul frame del riquadro.
...
void [!output MAIN_FRAME_CLASS]::OnClose()
{
	...
	//la finestra principale sta per essere chiusa, esecuzione codice di pulizia
