// PreviewHandler.h: declaración del controlador de vista previa
...
protected:
	...
	{
		// cree aquí el control de vista previa
...
public:
	virtual HRESULT InitializeDocumentPreview(HWND hWndParent, RECT* prc)
	{
		...
		if (pCtrl == NULL)
		{
			ATLTRACE2(atlTraceGeneral, 4, L"InitializeDocumentPreview: el puntero al control de vista previa es NULL.\n");
			return E_POINTER;
		}
		...
		if (m_pDocument == NULL) 
		{
			ATLTRACE2(atlTraceGeneral, 4, L"InitializeDocumentPreview: el puntero al documento es NULL.\n");
			return E_POINTER;
		}
		...
		{
			ATLTRACE2(atlTraceGeneral, 4, L"InitializeDocumentPreview: error al crear el control de vista previa. Código de error: %d\n", GetLastError());
			return E_FAIL;
		}
		return S_OK;
	}
