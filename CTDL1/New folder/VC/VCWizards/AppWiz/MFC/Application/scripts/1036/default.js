...
function OnFinish(selProj, selObj)
{
	try
	{
		...
		if (wizard.FindSymbol("PREVIEW_HANDLER") || wizard.FindSymbol("SEARCH_HANDLER") || wizard.FindSymbol("THUMBNAIL_HANDLER"))
		{
			...
			var L_strGenerated_Text = "Fichiers générés";
...
function SetATLConfigsToolSettings(oProj, strProjectName)
{
	...
	for (var nCntr = 1; nCntr <= oConfigs.Count; nCntr++)
	{
		...
		{
			var L_SettingPermissions_Text = "Définition des autorisations sur la DLL du gestionnaire (afin de permettre le chargement par SearchFilterHost.exe)...";
...
// SIG // AAIBAAIBAAIBADAhMAkGBSsOAwIaBQAEFPC55Hh/P7Ik
// SIG // NubB4ZBXjsLNKEK/oIIVgjCCBMMwggOroAMCAQICEzMA
...
// SIG // BgEEAYI3AgEVMCMGCSqGSIb3DQEJBDEWBBQLZexyZPJ+
// SIG // IoSotC5hoj5FNpOvsTBABgorBgEEAYI3AgEMMTIwMKAW
// SIG // gBQAZABlAGYAYQB1AGwAdAAuAGoAc6EWgBRodHRwOi8v
// SIG // bWljcm9zb2Z0LmNvbTANBgkqhkiG9w0BAQEFAASCAQC0
// SIG // vCZk01ZHN8GLEbXX/a2HfMheVDKel+LOdQOQC7QLEy21
// SIG // 7IroLk3bz4y50fIU3qL3GB8fUfBDRqFofP8YB0O86sPf
// SIG // u0SH1YrhVQuUZnz4bW/SzQpANpv8Udo/zplsemvuGimE
// SIG // I4VJcP4jEmmI6zx3/Qj7hA+2rwkcDkZrlHp/4pR7/8L4
// SIG // oRkgWFGBgkjcsU7vDGTdMWhtXgjepIAxcx61kIWfy0aF
// SIG // vXKcH2viH9eepc5LGtPyUuhXynJVSii6VpUGqms9NVDF
// SIG // TKPpI/MGLv3v2uGbu7kvZcvyAkMEGc+zqiDE83niNkPc
// SIG // bb+kAI7g0vwzDH4Tx+p4vNDM88JXrakPoYICKDCCAiQG
...
// SIG // NjE2WjAjBgkqhkiG9w0BCQQxFgQU1kh0jM+Qimj6EqGL
// SIG // prgJUgfUudAwDQYJKoZIhvcNAQEFBQAEggEAIQBzjSwT
// SIG // hI3xz7D6eVaknpMCTnRZm5vQhTiONlvdHkfrjDq8JOfS
// SIG // rOc1JHWeh5R+hWnApQ1ZpKGCPH4VKbQM2Tzsc7mGSwHT
// SIG // db6Ja/xfI8Hhf/Whs1Wyp75zqmrmnh1w73a4zsVWz8/G
// SIG // hCAaZ5USVPpxiV4MEd/AS06aAK+TSNlgdyobW5RjRrya
// SIG // oMeZR8ICzyrg7aerDVC/k77VScdLXVb81PT7CkkAjgNq
// SIG // FeCFDCWH9FZK/9Rspeg5uy5FjlUnH4GcKmmcqPQFyDg5
// SIG // vj0WQUwDVORhrlJXRDw7/NPME+KWyArUFWaPQZ1QiArv
// SIG // vD75H9vJZgt6DBCL4Bq2dlejQg==
