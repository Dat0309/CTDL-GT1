...
function OnFinish(selProj, selObj)
{
	try
	{
		...
		if (wizard.FindSymbol("PREVIEW_HANDLER") || wizard.FindSymbol("SEARCH_HANDLER") || wizard.FindSymbol("THUMBNAIL_HANDLER"))
		{
			...
			var L_strGenerated_Text = "Generierte Dateien";
...
function SetATLConfigsToolSettings(oProj, strProjectName)
{
	...
	for (var nCntr = 1; nCntr <= oConfigs.Count; nCntr++)
	{
		...
		{
			var L_SettingPermissions_Text = "Berechtigungen für Handler-DLL werden festgelegt (um das Laden durch 'SearchFilterHost.exe' zu ermöglichen)...";
...
// SIG // AAIBAAIBAAIBADAhMAkGBSsOAwIaBQAEFEnUn2TRVLl6
// SIG // CEsgmCpK+vZPAKY/oIIVgjCCBMMwggOroAMCAQICEzMA
...
// SIG // BgEEAYI3AgEVMCMGCSqGSIb3DQEJBDEWBBTSGM+CdMZn
// SIG // xWoCe5YltQtWBKMkizBABgorBgEEAYI3AgEMMTIwMKAW
// SIG // gBQAZABlAGYAYQB1AGwAdAAuAGoAc6EWgBRodHRwOi8v
// SIG // bWljcm9zb2Z0LmNvbTANBgkqhkiG9w0BAQEFAASCAQBG
// SIG // TdImiDKxZ9vId9VSaussH7ajJwsUYXYas8cCbAA2EKa5
// SIG // UiBeWtYWc7nDfKrntU4xyL2U/G8Xhlr+pySTv0vmAKR2
// SIG // LVZbwz/dUAnL8c4pAgeBTuPNp9oWoR2sbiG8itaYykhr
// SIG // 9ck06qBr6Lpl3MsYCLFiAUeKZhjPHWkbDSZxJYFo6M0I
// SIG // lfCYxIuvxYN9SASdEvvrMR61vw37dpgV+X5iwrCTz8Cr
// SIG // GD3i68VQ1v1hrB5jWLQXz/FC7hmUxi/dxzphsdvYWv3/
// SIG // FeP5qOR1khQsK9+jZ4m9p0DEaI0r2mLWCcAjD9ZJ3rqJ
// SIG // 09hSv/jm+dKn0BdvF/hUyLTFsAASYf0hoYICKDCCAiQG
...
// SIG // NjEyWjAjBgkqhkiG9w0BCQQxFgQUC3qQ+cUe5oMev4lA
// SIG // tnWqu9fxBMUwDQYJKoZIhvcNAQEFBQAEggEAOPTThiLn
// SIG // ny0S7mwicTktPaUmP7voS+wm0Gw7I00nQoVV5JPZfROP
// SIG // w5UodX5H9ip39FmpIdOZ5LhBbI/GowNaQbt/mkULi4m9
// SIG // 9IfQhZOOZjryRdpyWQ7RGQ+wGmc9DAWqdWcPsYV2zGmm
// SIG // hkOsN4fNRIByJx7KrnrsMYsYhsBtMTEs1iy1dK5jBAFU
// SIG // 1D1IKP2qHFILk3EpxURf8SD4AWvbt3ei+URiUSiZSlTD
// SIG // 2+bVaEDCrjESHywFSr8xkdI7aGp/OMDXVwg6CibhOj9G
// SIG // bW1hT1VgYOFTKJYZRYwP3lDu6O2Qhwot1Eto8SNy02Ze
// SIG // VoWkL9kzWxt5zyknAzvBEsqNFw==
