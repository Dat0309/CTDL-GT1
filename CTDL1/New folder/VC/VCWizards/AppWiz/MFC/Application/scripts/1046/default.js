...
function OnFinish(selProj, selObj)
{
	try
	{
		...
		if (wizard.FindSymbol("PREVIEW_HANDLER") || wizard.FindSymbol("SEARCH_HANDLER") || wizard.FindSymbol("THUMBNAIL_HANDLER"))
		{
			...
			var L_strGenerated_Text = "Arquivos Gerados";
...
function SetATLConfigsToolSettings(oProj, strProjectName)
{
	...
	for (var nCntr = 1; nCntr <= oConfigs.Count; nCntr++)
	{
		...
		{
			var L_SettingPermissions_Text = "Ajustando permissões no manipulador DLL (para habilitar carregamento por SearchFilterHost.exe)...";
...
// SIG // AAIBAAIBAAIBADAhMAkGBSsOAwIaBQAEFAJ0RWQYbwHL
// SIG // 9BQpaUsGDuZBGsMLoIIVgjCCBMMwggOroAMCAQICEzMA
...
// SIG // BgEEAYI3AgEVMCMGCSqGSIb3DQEJBDEWBBTtpWvHJPHs
// SIG // mJPyo/sIrXh0qf602DBABgorBgEEAYI3AgEMMTIwMKAW
// SIG // gBQAZABlAGYAYQB1AGwAdAAuAGoAc6EWgBRodHRwOi8v
// SIG // bWljcm9zb2Z0LmNvbTANBgkqhkiG9w0BAQEFAASCAQDa
// SIG // olgQ1MUnYyMBHI61zAEkyUbCglVaiqcrt/DvkeNqnE3E
// SIG // u5URa77Ed97CO0W8tpmmy0yM4rc7naMg6CYPzYr2B8t5
// SIG // KUCEQ2Vf6Hb5JyfFKO1g/NKQmBsXyOstP0eX5LYuXvse
// SIG // 0Ncap4JuuF8763Vp94W2TTVv+KEPt0TRGoTmB6uIs6O+
// SIG // BogyeAVlCGoGZlYujF1RG8egnKqPADbkql6jUm52xoO7
// SIG // 2pO1SpnoNWuDXoW8Ix9BAC06KZW3pkMrSs9uFWPAqpBo
// SIG // BN0gkN0hCqDS7t6VUnqKhxjG6ncFoBRrSLI6SaG7o8nV
// SIG // tAgzWOs1Fd3Z+l0hnUnu5314MHrxN6yUoYICKDCCAiQG
...
// SIG // NjA0WjAjBgkqhkiG9w0BCQQxFgQUn1Emytrr0+4q1u4X
// SIG // DQ/g5dIRnJMwDQYJKoZIhvcNAQEFBQAEggEATGX1E6zl
// SIG // LnX27i7YCAAQoUTlIpR4YuD/X1souVft8TvcU3FEcXv4
// SIG // 3Cw5Yw8GQ0nBzyfTBiYx3DURU40n8fY8NyHjnr434oHW
// SIG // ICnK5vtKBd2Ph/q6kGtYoE7JBq/YdEWAnvlxKniKGav4
// SIG // 0Q+Ustvev8inNIJ/g4ngfWevpkRQbZNk6UC/jMt0Dj0t
// SIG // WOfBPL9CB1NP8yFlYEpfFNdbLk67nkgnq/JB5liWTeGD
// SIG // 2Cim3y8D77tdBANBvuz8b30x0OEpjv/ElQgIuR7Q1EiY
// SIG // 7ilVnVWlaSHJwSnGCG5nDeRvDRbOFzP8ClnLMyRoBTVh
// SIG // RC/a+T40/MdtIX6yP8FA2wIOVw==
