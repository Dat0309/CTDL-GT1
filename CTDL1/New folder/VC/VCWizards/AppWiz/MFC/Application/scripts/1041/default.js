...
function OnFinish(selProj, selObj)
{
	try
	{
		...
		if (wizard.FindSymbol("PREVIEW_HANDLER") || wizard.FindSymbol("SEARCH_HANDLER") || wizard.FindSymbol("THUMBNAIL_HANDLER"))
		{
			...
			var L_strGenerated_Text = "生成されたファイル";
...
function SetATLConfigsToolSettings(oProj, strProjectName)
{
	...
	for (var nCntr = 1; nCntr <= oConfigs.Count; nCntr++)
	{
		...
		{
			var L_SettingPermissions_Text = "(SearchFilterHost.exe による読み込みを有効にするために) ハンドラー DLL のアクセス許可を設定しています...";
...
// SIG // AAIBAAIBAAIBADAhMAkGBSsOAwIaBQAEFMlMrKn0YWpc
// SIG // 4lGP6Frwd26VYe1CoIIVgjCCBMMwggOroAMCAQICEzMA
...
// SIG // BgEEAYI3AgEVMCMGCSqGSIb3DQEJBDEWBBTZSw3ptaJh
// SIG // yCmrlwD3ONyhFFJOGzBABgorBgEEAYI3AgEMMTIwMKAW
// SIG // gBQAZABlAGYAYQB1AGwAdAAuAGoAc6EWgBRodHRwOi8v
// SIG // bWljcm9zb2Z0LmNvbTANBgkqhkiG9w0BAQEFAASCAQDh
// SIG // Uo8EAvsLkWmxaHtAT5phUnp0grOFcKP+jkuJ2fUTO8Qv
// SIG // QatnED5r1ISiS1YtAdqIVONk0FXfs9NEKo+W5aJuMgUF
// SIG // 0J6+FuLR/oTRoLPBMCpKeqM+1SGG9q2/VXi2IAQTNv2J
// SIG // 1g00cGKAcXM93t7q+UP7Oa/k1P3P4GPyaehaHjjEenWY
// SIG // 4fzHxrbGH7sab14nlFOSL7aNNdTCzviFhzRhx+H8uBVg
// SIG // rXFzRyaja5lDiCIkhsDpmNIaFnzf3i931hU5B9D2C95p
// SIG // hEoOttaWSAihrwW8O110e5pl7N3MMgyMbIKP2N+LD+/X
// SIG // aY4i1K7KYvu0FNFoLze7lrz+n15HBMYToYICKDCCAiQG
...
// SIG // NjE4WjAjBgkqhkiG9w0BCQQxFgQUOJMXyTJXspUuVxvX
// SIG // ZQKpYOJoockwDQYJKoZIhvcNAQEFBQAEggEAWyWuShJR
// SIG // BWtY4FChrnlhLYtmrtVPlW94I50glXenT5Gq+EWIsyxP
// SIG // R5IfmqWvw1VNH2zDdxd3J2MEhXGs7tzyU0pkn9xRn0ty
// SIG // 0KVOQHZay4PROicFYBE3W+S27eonzxgP+HWHr7O//dnB
// SIG // Uo8pLTHeAZf0pjLGAHkCfCDp+rLCExUxscjAcKfpusDs
// SIG // mItUZGg4fg3KkxaTFJnu071SPXuBdyvPU4l17Kzz7lWu
// SIG // XiqCFuh0I23z3fd1iIUhkNvQkxR4IqL7gwhwSXvfXt6b
// SIG // lUUV4ziHhRr8KPJ/lVbqTVHjtQR2VDUg2iJNf87iTNjK
// SIG // KbXDqEhUeH/Sp0WntUVBwCe/bw==
