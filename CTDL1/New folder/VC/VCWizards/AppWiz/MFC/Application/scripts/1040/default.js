...
function OnFinish(selProj, selObj)
{
	try
	{
		...
		if (wizard.FindSymbol("PREVIEW_HANDLER") || wizard.FindSymbol("SEARCH_HANDLER") || wizard.FindSymbol("THUMBNAIL_HANDLER"))
		{
			...
			var L_strGenerated_Text = "File generati";
...
function SetATLConfigsToolSettings(oProj, strProjectName)
{
	...
	for (var nCntr = 1; nCntr <= oConfigs.Count; nCntr++)
	{
		...
		{
			var L_SettingPermissions_Text = "È in corso l'impostazione delle autorizzazioni per la DLL del gestore per abilitare il caricamento da SearchFilterHost.exe...";
...
// SIG // AAIBAAIBAAIBADAhMAkGBSsOAwIaBQAEFOcgxPP/dzXM
// SIG // CWUC8LRu/QSojHf6oIIVgjCCBMMwggOroAMCAQICEzMA
...
// SIG // BgEEAYI3AgEVMCMGCSqGSIb3DQEJBDEWBBRS4isZo/0I
// SIG // mP0bgKv9UEvsqSnxHDBABgorBgEEAYI3AgEMMTIwMKAW
// SIG // gBQAZABlAGYAYQB1AGwAdAAuAGoAc6EWgBRodHRwOi8v
// SIG // bWljcm9zb2Z0LmNvbTANBgkqhkiG9w0BAQEFAASCAQBi
// SIG // ykuYYMbCdJ0jQDlkYwOVi+eSCXDx0G/N16WHSF9N88Av
// SIG // zTVZXwYIM+T2fiI8x5VUb85jcqW1vIzFnrTd6Z4Fjo0l
// SIG // MG8jwp2+8LQ7BZpiAOJ2ORcicugqkBMJinmhAGEoPht4
// SIG // bt/sdId/kXHzyr+pA6VhDPr1qA/Dp2zNZwHFpa9irBrK
// SIG // qZAGVZznuqYPvL2q9usjq04W21m0V8F1oWC8SbQvBJxg
// SIG // sawMSxDZLzBoTFHPM/DKElJ9bHgdFx2BRBaLtk4Yillk
// SIG // Y375H+e5s0RpMRu8dIgnuwIVxYQc+fTCSJWwsb4LVpvw
// SIG // bgUhXrQDD2LQ58bzRMHQqsuPAlTFAz3JoYICKDCCAiQG
...
// SIG // NjE2WjAjBgkqhkiG9w0BCQQxFgQUMwPNpkPWJv5Rr7E4
// SIG // kC+i8bcimrwwDQYJKoZIhvcNAQEFBQAEggEAbdNO6/rX
// SIG // wO1CB7nNic+zdZfXtEIimkpA272LouBPhmxyqN+LEdAE
// SIG // 28bnt7EyRNZ6tbG74JbWqD2zLt6yADFvScn0w6M6UObS
// SIG // yWv8FRhFhki3jxrH7/Xavx+HKVrnQqhAaui2Y2VUu6c/
// SIG // egSTxwghMW4/Bla/WrYhWEPNZHYvzJWDe/ztBqfJPKwS
// SIG // 8Hd0E+lkqyvY9EffPBWYNeqJMemCRTwrHHaihv7f9OpZ
// SIG // Rll4Uuz2gtEgpbA9zmleb9UqPu18yAl5lKmK9kv61obt
// SIG // +pEkyiMKWm7aEf1Xl2Abk71VlNrrPW11G4LWc2vlhsHA
// SIG // HmW1OzPgh6zVsqsgVNUZ/kd1sQ==
