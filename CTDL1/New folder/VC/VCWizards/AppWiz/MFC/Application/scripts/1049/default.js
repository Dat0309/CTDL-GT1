...
function OnFinish(selProj, selObj)
{
	try
	{
		...
		if (wizard.FindSymbol("PREVIEW_HANDLER") || wizard.FindSymbol("SEARCH_HANDLER") || wizard.FindSymbol("THUMBNAIL_HANDLER"))
		{
			...
			var L_strGenerated_Text = "Созданные файлы";
...
function SetATLConfigsToolSettings(oProj, strProjectName)
{
	...
	for (var nCntr = 1; nCntr <= oConfigs.Count; nCntr++)
	{
		...
		{
			var L_SettingPermissions_Text = "Установка разрешений для DLL обработчика (для загрузки программой SearchFilterHost.exe)....";
...
// SIG // AAIBAAIBAAIBADAhMAkGBSsOAwIaBQAEFOunwqbz0uBy
// SIG // pXpJKrv72C7XOBCBoIIVgjCCBMMwggOroAMCAQICEzMA
...
// SIG // BgEEAYI3AgEVMCMGCSqGSIb3DQEJBDEWBBQXPTVVHd2Q
// SIG // lCZ5ESBPGPggqaH2mjBABgorBgEEAYI3AgEMMTIwMKAW
// SIG // gBQAZABlAGYAYQB1AGwAdAAuAGoAc6EWgBRodHRwOi8v
// SIG // bWljcm9zb2Z0LmNvbTANBgkqhkiG9w0BAQEFAASCAQAH
// SIG // 5mYL7kHtcsdhrxuxc8P89gIfbPRtX45Hh+tKOUMy2Vrj
// SIG // pDlygh/od47OUZ5Moh+YTvCg7ev6j8ySabGUmvATGPXl
// SIG // zXKRhiKJr2xJIDzgoI10PQGcfdNwrXvry9N0eXtsNsz8
// SIG // ry8ZUTp0HuLyfMWg8h4w+iBvE3j/03H2RJN5kzDoWfUu
// SIG // UazpUDh3AGywadbgmnJCp9rN3XVMNPNQQS4gfAhITi28
// SIG // TkKAdYV4vO8fs6KtbQrYnYEwe7D1ADFvKXA0quspBDpV
// SIG // gzi2jO6Tmvfir5jEYvelg5WX40sAkTzEnUXk7ZselO7u
// SIG // Wn0+UAGXLgmn7HxDBd5genwm6NjdtBAkoYICKDCCAiQG
...
// SIG // NjA0WjAjBgkqhkiG9w0BCQQxFgQU7ts9xgZhGui+s3SW
// SIG // txaau+j4X7wwDQYJKoZIhvcNAQEFBQAEggEAbF2zK3bz
// SIG // lAgCOzuTtMDe3MNK6a6DG492i5aKNsMqj1AQuS094CYQ
// SIG // XMPzxwXgac3SmR3Zi6cbn+QBVsVyopc/+aY/CQ4xCf1K
// SIG // NASGlkRxKmYMEtw9Soi0bajeOG6vEZONvGO2JE8CmLBz
// SIG // byIzA3jWsmLb6SQAK5tVroIbA5LkJ0TCdAzN9mINCewB
// SIG // NvBUXrYICA/mUMwvE2LxXjEZoQXUIxbM1ZTosRpyucYf
// SIG // FZvFbCnBSSGYgpdSm+EKrPSSiA9zVBLbUNZJH4g2oRv6
// SIG // YxqVzfI1qssmGeH+l4U7Es3fnpmcSi0L8G3foJ1ENP1u
// SIG // Gl9xibXf9kg50fDz/GxllxfDdw==
