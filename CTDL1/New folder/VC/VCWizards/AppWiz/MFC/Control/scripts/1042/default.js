...
function AddSpecificConfig(proj, strProjectName)
{
	...
	for (var nCntr = 1; nCntr <= oConfigs.Count; nCntr++)
	{
		...
		if (wizard.FindSymbol("RUNTIME_LICENSE"))
		{
			...
			var L_CopyingRuntimeLicense1_Text = "런타임 라이선스를 복사하고 있습니다...";
...
function AddHelpBuildSteps(projObj, strProjectName)
{
	try
	{
		...
		strCodeTool[0] = "echo // ";
		var L_CodeFragment1_Text = "생성된 도움말 맵 파일입니다.  $(ProjectName).HPJ에서 사용됩니다.";
		strCodeTool[0] += L_CodeFragment1_Text + " > \"hlp\\$(ProjectName).hm\"";
		strCodeTool[1] = "echo. >> \"hlp\\$(ProjectName).hm\"";
		strCodeTool[2] = "echo // ";
		var L_CodeFragment2_Text = "명령 (ID_* 및 IDM_*)";
		...
		strCodeTool[5] = "echo // ";
		var L_CodeFragment3_Text = "프롬프트 (IDP_*)";
		...
		strCodeTool[8] = "echo // ";
		var L_CodeFragment4_Text = "리소스 (IDR_*)";
		...
		strCodeTool[11] = "echo // ";
		var L_CodeFragment5_Text = "대화 상자 (IDD_*)";
		...
		strCodeTool[14] = "echo // ";
		var L_CodeFragment6_Text = "프레임 컨트롤 (IDW_*)";
		...
		if (fileObj1 != null)
		{
			for (var i=1; i<=fileObj1.FileConfigurations.Count; i++)
			{
				...
				if (config != null)
				{
					...
					L_ToolDesc1_Text = "도움말 파일을 만들고 있습니다...";
		...
		if (fileObj2 != null)
		{
			for (var i=1; i<=fileObj2.FileConfigurations.Count; i++)
			{
				...
				if (config != null)
				{
					...
					L_ToolDesc2_Text = "도움말 컴파일러에 대한 맵 파일을 생성하고 있습니다...";
...
// SIG // AAIBAAIBAAIBADAhMAkGBSsOAwIaBQAEFJ9naDREG28w
// SIG // 34U3d/SMRKa+jJhyoIIVgjCCBMMwggOroAMCAQICEzMA
...
// SIG // BgEEAYI3AgEVMCMGCSqGSIb3DQEJBDEWBBSG8mtuK/+k
// SIG // BExngBfy9xJurJUAczBABgorBgEEAYI3AgEMMTIwMKAW
// SIG // gBQAZABlAGYAYQB1AGwAdAAuAGoAc6EWgBRodHRwOi8v
// SIG // bWljcm9zb2Z0LmNvbTANBgkqhkiG9w0BAQEFAASCAQCe
// SIG // yYRA8IyelBuhFvFvN8WGY2Qj2HUNTvTBgdXNeSdbeV1n
// SIG // 0VcHoTEJm5TZFnSg5YZCOwrb6zzfGPHzh3Sil7z/hAA6
// SIG // jW+Rhs17Rj+dR5frikXBlspCts5g7K9c8d/3nCt2VJMS
// SIG // yVId6l+Kmqa9jBkHK63onNuBQwDlP9B90i5hA1KlOKhd
// SIG // iwqqtVNmeMid9nZzsepBsR00J/ljOEd+MTnm3+0ljUjD
// SIG // NoZgOveD3wFUG/nqkz5hnjeM4mabdCFo+7Rr3vn8jXAk
// SIG // tuGYW9cMDGTAf1FsS7IEfQVXN6YptW9tXXmoKx2E0NQ4
// SIG // 7PC1Hu3ybWHK52R0OWWye3fFwzkiVA/goYICKDCCAiQG
...
// SIG // NjAzWjAjBgkqhkiG9w0BCQQxFgQUxYtyHMhQsDqCqgwM
// SIG // OiHuo1dlgDIwDQYJKoZIhvcNAQEFBQAEggEAK3OkfHe9
// SIG // YwCk3+C+mmBOL/YCGtM00Gt6topA5BOf4C6WxvXXmDRI
// SIG // dT/EiqsswoS2LQ0lXjTqGmDc5fOaFokgB5C3SL7US43n
// SIG // ljCzeBNY3KC4mbNoYTjQpCYWeRFpa/CTFmH3z5JeqUnY
// SIG // B2U/bUZmi+eCk+RMU8OIgz3p1e0Bk8MoaKudXt1ogq9H
// SIG // fqwdt+gjg7nuDJ1m65Zl1GH/oQFlsBYTH37Lhx2IHtlG
// SIG // lLbtmqjSfppk0hAillMM2zdVFVIMcmTGj5oLPPoSQHhP
// SIG // 4HMD4/QfO5nFZAXlUss2nivfLrYqEBChd32f9GmNWRmj
// SIG // d4zzYH9L9g2q1oVJAYvNuJqr/g==
