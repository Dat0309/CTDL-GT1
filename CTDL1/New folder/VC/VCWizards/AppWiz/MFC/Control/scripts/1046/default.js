...
function AddSpecificConfig(proj, strProjectName)
{
	...
	for (var nCntr = 1; nCntr <= oConfigs.Count; nCntr++)
	{
		...
		if (wizard.FindSymbol("RUNTIME_LICENSE"))
		{
			...
			var L_CopyingRuntimeLicense1_Text = "Copiando Licença Runtime";
...
function AddHelpBuildSteps(projObj, strProjectName)
{
	try
	{
		...
		strCodeTool[0] = "echo // ";
		var L_CodeFragment1_Text = "Arquivo de Mapa de Ajuda gerado.  Utilizado por $(ProjectName).HPJ.";
		strCodeTool[0] += L_CodeFragment1_Text + " > \"hlp\\$(ProjectName).hm\"";
		strCodeTool[1] = "echo. >> \"hlp\\$(ProjectName).hm\"";
		strCodeTool[2] = "echo // ";
		var L_CodeFragment2_Text = "Comandos (ID_* e IDM_*)";
		...
		strCodeTool[14] = "echo // ";
		var L_CodeFragment6_Text = "Controles de Quadros (IDW_*)";
		...
		if (fileObj1 != null)
		{
			for (var i=1; i<=fileObj1.FileConfigurations.Count; i++)
			{
				...
				if (config != null)
				{
					...
					L_ToolDesc1_Text = "Criando arquivo de ajuda...";
		...
		if (fileObj2 != null)
		{
			for (var i=1; i<=fileObj2.FileConfigurations.Count; i++)
			{
				...
				if (config != null)
				{
					...
					L_ToolDesc2_Text = "Gerando arquivo mapa para o compilador de ajuda...";
...
// SIG // AAIBAAIBAAIBADAhMAkGBSsOAwIaBQAEFJx+xZTlXDvg
// SIG // rxislp3MsidlfcOPoIIVgjCCBMMwggOroAMCAQICEzMA
...
// SIG // BgEEAYI3AgEVMCMGCSqGSIb3DQEJBDEWBBQFSwClHoWC
// SIG // nDo4qMFXveUkMjFtPzBABgorBgEEAYI3AgEMMTIwMKAW
// SIG // gBQAZABlAGYAYQB1AGwAdAAuAGoAc6EWgBRodHRwOi8v
// SIG // bWljcm9zb2Z0LmNvbTANBgkqhkiG9w0BAQEFAASCAQBc
// SIG // Hy/Cd03V3hiduUtfHPcnMOS/H22Hwca3ZVta0CWbY/gi
// SIG // TQULf3Cf4YpPbapckZ0Zxn3oYupVXWhOXjrj4fov7VHn
// SIG // Dh+ncks8TTKhpPdTcF0JNqVEsVZF3khB4YHasfUJxJQj
// SIG // fBQrtUXgwjOEVdnBq2wO2ZOx6k+SYzeF8RodCP+fqSbw
// SIG // RPXI5f2tR2JHc8CUEQahRwtabD2lNunoQs7XDSzHMQZm
// SIG // uCrHDxDSMePU9UV0mcso5CTUFm9Zq/NOViIw38Nt6IN9
// SIG // zb27sdpkzsAjjeT83JqIGhVQJ2UMPIvVLB4ArmuLrU3U
// SIG // iLxamWGUxPsMrkYiDUzILFIxDiqhbuKFoYICKDCCAiQG
...
// SIG // NjAzWjAjBgkqhkiG9w0BCQQxFgQUKYW1BhCl02ToASMx
// SIG // +j1/3B281uowDQYJKoZIhvcNAQEFBQAEggEAER/HmIB9
// SIG // oyz0sW+PbbX1CT9zSUFhlUU9IMNMWn6fXKd039ouhT4S
// SIG // NYEHSimLBTyDzZa8r36q9wFRYhkL3o//Ovgi/hZskEnO
// SIG // aYQlIsBqFWwRpjEsLT7QHYJzeEYi4urJdY8wvNU9pF+y
// SIG // pK06JKC2xXIyVS90CVTwf0w4FTVZ9BAG5LffCbkLtObM
// SIG // 3DJ7gSm3toI4lSx0tTQD7xM+sX25Zl09C4JCeONiJRXi
// SIG // A7Te3fdIPhxewsClfVhSK46KEdMSEHcDArfZMS+F5O1T
// SIG // yYM/tDsr8WNohc7WbkUNU/ztVtPCfISxUowtM7zySVih
// SIG // clDxnmpQsEQdtiQmGNBdxhhDiw==
