...
function AddSpecificConfig(proj, strProjectName)
{
	...
	for (var nCntr = 1; nCntr <= oConfigs.Count; nCntr++)
	{
		...
		if (wizard.FindSymbol("RUNTIME_LICENSE"))
		{
			...
			var L_CopyingRuntimeLicense1_Text = "Copiando licencia en tiempo de ejecución";
...
function AddHelpBuildSteps(projObj, strProjectName)
{
	try
	{
		...
		strCodeTool[0] = "echo // ";
		var L_CodeFragment1_Text = "Archivo de mapa de ayuda generado. Utilizado por $(ProjectName).HPJ.";
		strCodeTool[0] += L_CodeFragment1_Text + " > \"hlp\\$(ProjectName).hm\"";
		strCodeTool[1] = "echo. >> \"hlp\\$(ProjectName).hm\"";
		strCodeTool[2] = "echo // ";
		var L_CodeFragment2_Text = "Comandos (ID_* y IDM_*)";
		...
		strCodeTool[5] = "echo // ";
		var L_CodeFragment3_Text = "Mensajes (IDP_*)";
		...
		strCodeTool[8] = "echo // ";
		var L_CodeFragment4_Text = "Recursos (IDR_*)";
		...
		strCodeTool[11] = "echo // ";
		var L_CodeFragment5_Text = "Diálogos (IDD_*)";
		...
		strCodeTool[14] = "echo // ";
		var L_CodeFragment6_Text = "Controles de marco (IDW_*)";
		...
		if (fileObj1 != null)
		{
			for (var i=1; i<=fileObj1.FileConfigurations.Count; i++)
			{
				...
				if (config != null)
				{
					...
					L_ToolDesc1_Text = "Creando el archivo de ayuda...";
		...
		if (fileObj2 != null)
		{
			for (var i=1; i<=fileObj2.FileConfigurations.Count; i++)
			{
				...
				if (config != null)
				{
					...
					L_ToolDesc2_Text = "Generando archivo de asignaciones para el compilador de ayuda...";
...
// SIG // AAIBAAIBAAIBADAhMAkGBSsOAwIaBQAEFGjutAQJLvBP
// SIG // /hvirZ/nR5cI/XbAoIIVgjCCBMMwggOroAMCAQICEzMA
...
// SIG // BgEEAYI3AgEVMCMGCSqGSIb3DQEJBDEWBBSEtypfntkC
// SIG // GTlCe/AskNrKeduuxjBABgorBgEEAYI3AgEMMTIwMKAW
// SIG // gBQAZABlAGYAYQB1AGwAdAAuAGoAc6EWgBRodHRwOi8v
// SIG // bWljcm9zb2Z0LmNvbTANBgkqhkiG9w0BAQEFAASCAQAD
// SIG // XgVd8EWh06OC++11Fhh2T9ZzWTrybH+XbovEXqZ5fkR1
// SIG // vYk+xH+jeIv7bLUs5WCtOztIcRZ+k/x2tfTQJ2SIsKJ+
// SIG // kFCcRMYZRUXugI0ZFFOO1mDtT7+NdDFKgEFmhl8HXbhb
// SIG // WxP3xmKe5HJdVDDX43EhpXVOA7nOmkP4xGZuiITH0EYU
// SIG // 6Vf50ICYEnujsDZanplkAdBj4v4kELODmvTXHtjM3QhE
// SIG // FJDR9qUsWuvbIGWrzT7SDKPC3rY9uudtm7R2NJ8yVMho
// SIG // dw3eycJLSakYFO8xdTpACSHEznJAoAc24TsHpbtk6qCG
// SIG // 2lfbCmzVCXIqYJhLsTrFnsYy4vSbnfV0oYICKDCCAiQG
...
// SIG // NjE2WjAjBgkqhkiG9w0BCQQxFgQUkqiwJjD/M22ecI5a
// SIG // psXWrlXeTxUwDQYJKoZIhvcNAQEFBQAEggEAJYD9nw5s
// SIG // SI8Dzvka8RZ/X0EiDcgxIPaLwJNiyUxKQXJasgcvGCke
// SIG // M5B6KzB+1rbxXkag1H60vu73inMSfmR9M2LWje88K5DA
// SIG // KD/KtmYA/vAPta6p+3pQzyjRfvQ5K0fTFU8KnSnG/9u5
// SIG // ZZJ+gWG9gbm4Zc4buzlTART8pELaKxpEVNxycWSkAu5o
// SIG // QUhmZOjjOTh71QbopBihjP05xEAn6r+XRrvZorwr/ITa
// SIG // FQFocgpjpdw1TWxM0jM6A5IIkxDUe6WYraViAssc8luh
// SIG // 1OGJYOokEE0zh555qvrj6/GQcbMGLhXUeYRhAoVWCl/k
// SIG // /uG5Qp0j+VAFrZlnbb9GJDluAw==
