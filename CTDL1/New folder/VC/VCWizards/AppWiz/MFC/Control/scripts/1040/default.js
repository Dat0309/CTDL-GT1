...
function AddSpecificConfig(proj, strProjectName)
{
	...
	for (var nCntr = 1; nCntr <= oConfigs.Count; nCntr++)
	{
		...
		if (wizard.FindSymbol("RUNTIME_LICENSE"))
		{
			...
			var L_CopyingRuntimeLicense1_Text = "Copia della licenza runtime in corso...";
...
function AddHelpBuildSteps(projObj, strProjectName)
{
	try
	{
		...
		strCodeTool[0] = "echo // ";
		var L_CodeFragment1_Text = "File Map della Guida generato. Utilizzato da $(ProjectName).HPJ.";
		strCodeTool[0] += L_CodeFragment1_Text + " > \"hlp\\$(ProjectName).hm\"";
		strCodeTool[1] = "echo. >> \"hlp\\$(ProjectName).hm\"";
		strCodeTool[2] = "echo // ";
		var L_CodeFragment2_Text = "Comandi (ID_* e IDM_*)";
		...
		strCodeTool[5] = "echo // ";
		var L_CodeFragment3_Text = "Prompt (IDP_*)";
		...
		strCodeTool[8] = "echo // ";
		var L_CodeFragment4_Text = "Risorse (IDR_*)";
		...
		strCodeTool[11] = "echo // ";
		var L_CodeFragment5_Text = "Finestre di dialogo (IDD_*)";
		...
		strCodeTool[14] = "echo // ";
		var L_CodeFragment6_Text = "Controlli frame (IDW_*)";
		...
		if (fileObj1 != null)
		{
			for (var i=1; i<=fileObj1.FileConfigurations.Count; i++)
			{
				...
				if (config != null)
				{
					...
					L_ToolDesc1_Text = "Preparazione del file della Guida in corso...";
		...
		if (fileObj2 != null)
		{
			for (var i=1; i<=fileObj2.FileConfigurations.Count; i++)
			{
				...
				if (config != null)
				{
					...
					L_ToolDesc2_Text = "Generazione del file map per il compilatore della Guida in corso...";
...
// SIG // AAIBAAIBAAIBADAhMAkGBSsOAwIaBQAEFCwN7jRcKeQm
// SIG // +uZIhxOcabzlY7oMoIIVgjCCBMMwggOroAMCAQICEzMA
...
// SIG // BgEEAYI3AgEVMCMGCSqGSIb3DQEJBDEWBBTthzMqzRM6
// SIG // CcTXeovuYqh8wHGo9TBABgorBgEEAYI3AgEMMTIwMKAW
// SIG // gBQAZABlAGYAYQB1AGwAdAAuAGoAc6EWgBRodHRwOi8v
// SIG // bWljcm9zb2Z0LmNvbTANBgkqhkiG9w0BAQEFAASCAQCf
// SIG // hY+c2falzx2dqN/x3OfYPAEkmCl9lR/+rPsz7oig/5MW
// SIG // bW3Pbh9afOXHcz3+LR2ehdf9HjazMei/IAj+hww3rec0
// SIG // uzRGJ2KVVnigc0/mYBMS3YncPYinyprVe1nVfWsxzGvZ
// SIG // HNRcfbY/bduQNEiR+NQF3G3AS54oYykfLC3Cshu2eLcF
// SIG // ppHC68i3+0b/nM2eLSqQ97XxWcbj1t64tJH+/yRZeOxc
// SIG // OLDMWwltinWMZH4+996t0JumSTbQ8Xc0/KobnWuaGnfq
// SIG // 8RL/I/J7KFXr2cAZ+59YUoLhIJp94ajqz5mjddWH7aMF
// SIG // VYEwpHQCXuUYhMPyds8GEMN/9qF9wb8ioYICKDCCAiQG
...
// SIG // NjE2WjAjBgkqhkiG9w0BCQQxFgQUcM77Ye0pZp/KcAFl
// SIG // iVxhEMHTOYswDQYJKoZIhvcNAQEFBQAEggEAi/KyJn+p
// SIG // /CzEOLqo3TxD+qYGDqiNL2MgCeEdVaVy4k+3kjhuJyt6
// SIG // o1Y/gI9GS78kQxgsqTvSPxkyaKVhlUDSxKVnaFjDIrmM
// SIG // IUUWRWBBRqVG/y7jior7qml1wKubrk6AaxgQrELjzrd9
// SIG // biWluhqSYtHQpjwFOF9XLIYaG9cNDwjlahu6ntqNgiS8
// SIG // gz6bs7MkbIjDRF93XJK9HZLCJo+IQZ86IusayQWvxWJT
// SIG // 0xP1RkUGU3s4nUL2gjBgZEspd0D9s8IPL7JaTaexUw5C
// SIG // zJXL9AmoHoRTr9p0/DhpQViVED5Cp3RKsOHeobdpgat7
// SIG // DKstKZSmxOPsDQ11gTh4IrG4Vg==
