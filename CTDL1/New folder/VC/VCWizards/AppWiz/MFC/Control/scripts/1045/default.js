...
function AddSpecificConfig(proj, strProjectName)
{
	...
	for (var nCntr = 1; nCntr <= oConfigs.Count; nCntr++)
	{
		...
		if (wizard.FindSymbol("RUNTIME_LICENSE"))
		{
			...
			var L_CopyingRuntimeLicense1_Text = "Kopiowanie licencji œrodowiska uruchomieniowego";
...
function AddHelpBuildSteps(projObj, strProjectName)
{
	try
	{
		...
		strCodeTool[0] = "echo // ";
		var L_CodeFragment1_Text = "Wygenerowany plik mapy pomocy.  U¿ywany przez $(ProjectName).HPJ.";
		strCodeTool[0] += L_CodeFragment1_Text + " > \"hlp\\$(ProjectName).hm\"";
		strCodeTool[1] = "echo. >> \"hlp\\$(ProjectName).hm\"";
		strCodeTool[2] = "echo // ";
		var L_CodeFragment2_Text = "Polecenia (ID_* i IDM_*)";
		...
		strCodeTool[5] = "echo // ";
		var L_CodeFragment3_Text = "Monituje o (IDP_*)";
		...
		strCodeTool[8] = "echo // ";
		var L_CodeFragment4_Text = "Zasoby (IDR_*)";
		...
		strCodeTool[11] = "echo // ";
		var L_CodeFragment5_Text = "Okna dialogowe (IDD_*)";
		...
		strCodeTool[14] = "echo // ";
		var L_CodeFragment6_Text = "Formanty ramki (IDW_*)";
		...
		if (fileObj1 != null)
		{
			for (var i=1; i<=fileObj1.FileConfigurations.Count; i++)
			{
				...
				if (config != null)
				{
					...
					L_ToolDesc1_Text = "Tworzenie pliku pomocy...";
		...
		if (fileObj2 != null)
		{
			for (var i=1; i<=fileObj2.FileConfigurations.Count; i++)
			{
				...
				if (config != null)
				{
					...
					L_ToolDesc2_Text = "Generowanie pliku mapy dla pomocy kompilatora...";
...
// SIG // AAIBAAIBAAIBADAhMAkGBSsOAwIaBQAEFOZWBQsjbjFa
// SIG // 2GGY1/EliwhgDG+GoIIVgjCCBMMwggOroAMCAQICEzMA
...
// SIG // BgEEAYI3AgEVMCMGCSqGSIb3DQEJBDEWBBRGu94rrq02
// SIG // sPLs4bgyn6v2BCPzwTBABgorBgEEAYI3AgEMMTIwMKAW
// SIG // gBQAZABlAGYAYQB1AGwAdAAuAGoAc6EWgBRodHRwOi8v
// SIG // bWljcm9zb2Z0LmNvbTANBgkqhkiG9w0BAQEFAASCAQAM
// SIG // 2t1rxMzoskFcitesXb1FdsKFudAVok9chM90sPMtFm7k
// SIG // +/rWtJDyRK5YzvtKll7wftbXkt5fspvjwILWxvSsX22u
// SIG // FB7DKo3Rap17DYH8cemo+pXtiHfChMQQQP7dQzh+s7/B
// SIG // 8yezeRUuwZ8zjKVI5dR4gUrXdxcejBECYxWBQxB5RhdZ
// SIG // GEn/EDBbOx9VSzqnBsfE9396RLl/dkbM0yFd7zBn6vRQ
// SIG // ezDYSWHdvUOT8JiZJGRcgojdvqzgkbrvsslbDjCJhFF5
// SIG // Q1I9vWS0ZzPRMsWLhTiWAspNdvLjH17bVY0geQm6UFNR
// SIG // knP2mmnjlTkLW3EZVzsfCtmTNFgXOc/EoYICKDCCAiQG
...
// SIG // NjAzWjAjBgkqhkiG9w0BCQQxFgQUHvOy9HtmAac8Qny1
// SIG // cp/PGC3pCU0wDQYJKoZIhvcNAQEFBQAEggEAm9XKNBJI
// SIG // OkpMzyWTmVSsNF7JoUdAILraBJ6Gm1HLel+nn7isQkTa
// SIG // IYMpxtaJvktgXZE6y+xBKwo6cUVFSshtIcbBSLapVEYm
// SIG // XgDRwUV/qICS/JTAkI+JJcjV8x+a5M/kkNgj6Y4oNLDS
// SIG // egK/ORw29ngFiCf3Q361sywjDZt3gCrQu+z3E8iWDvOB
// SIG // aoVPD3rYzVPFRSOO5C77JQor6uIK94YEHTQ76ny0Q3E5
// SIG // Wvr5hWuodV/eb6u3kI181lSiWpMYcwuDfq05rpaIZxg7
// SIG // MIuE24KJXYOeAVIS6phI1fPlqF5qxKSWw7Bu1UYZGi18
// SIG // JH7UAk0CjiPnec6kjcuMC0QAWg==
