...
function AddSpecificConfig(proj, strProjectName)
{
	...
	for (var nCntr = 1; nCntr <= oConfigs.Count; nCntr++)
	{
		...
		if (wizard.FindSymbol("RUNTIME_LICENSE"))
		{
			...
			var L_CopyingRuntimeLicense1_Text = "Laufzeitlizenz wird kopiert";
...
function AddHelpBuildSteps(projObj, strProjectName)
{
	try
	{
		...
		strCodeTool[0] = "echo // ";
		var L_CodeFragment1_Text = "Generierte Hilfezuordnungsdatei. Verwendet von $(ProjectName).HPJ.";
		strCodeTool[0] += L_CodeFragment1_Text + " > \"hlp\\$(ProjectName).hm\"";
		strCodeTool[1] = "echo. >> \"hlp\\$(ProjectName).hm\"";
		strCodeTool[2] = "echo // ";
		var L_CodeFragment2_Text = "Befehle (ID_* and IDM_*)";
		...
		strCodeTool[5] = "echo // ";
		var L_CodeFragment3_Text = "Eingabeaufforderungen (IDP_*)";
		...
		strCodeTool[8] = "echo // ";
		var L_CodeFragment4_Text = "Ressourcen (IDR_*)";
		...
		strCodeTool[11] = "echo // ";
		var L_CodeFragment5_Text = "Dialogfelder (IDD_*)";
		...
		strCodeTool[14] = "echo // ";
		var L_CodeFragment6_Text = "Rahmensteuerelemente (IDW_*)";
		...
		if (fileObj1 != null)
		{
			for (var i=1; i<=fileObj1.FileConfigurations.Count; i++)
			{
				...
				if (config != null)
				{
					...
					L_ToolDesc1_Text = "Hilfedatei wird erstellt...";
		...
		if (fileObj2 != null)
		{
			for (var i=1; i<=fileObj2.FileConfigurations.Count; i++)
			{
				...
				if (config != null)
				{
					...
					L_ToolDesc2_Text = "Zuordnungsdatei für den Hilfecompiler wird generiert...";
...
// SIG // AAIBAAIBAAIBADAhMAkGBSsOAwIaBQAEFPuUTe9xrSUv
// SIG // KjLItgb1iNz0YHrZoIIVgjCCBMMwggOroAMCAQICEzMA
...
// SIG // BgEEAYI3AgEVMCMGCSqGSIb3DQEJBDEWBBTLib+rFn8c
// SIG // d8F1Jrtn07oxoglUnjBABgorBgEEAYI3AgEMMTIwMKAW
// SIG // gBQAZABlAGYAYQB1AGwAdAAuAGoAc6EWgBRodHRwOi8v
// SIG // bWljcm9zb2Z0LmNvbTANBgkqhkiG9w0BAQEFAASCAQB4
// SIG // +3I4qZXSCaiZ9vryyTPYZw+FMUmZU5lrHnrcKxiCsTkx
// SIG // 8/Pb1RbYLCX2Fvs/nXq7itjCLCqvQ38IIHpIM7+UrFvc
// SIG // uu1uX9//OMsmuiE327iRgW/TDrxOvPC8o6n6n6Uq0+E+
// SIG // YyS9hLeSvUhF3FxBelXOA0lSmSJTF0qRBfQGSD5Fcvfy
// SIG // WqnZhAYN1+ABmrbNGQLF1ZwsW/pIaC3V/p+TO8+4bKbS
// SIG // iPmAFilxCSUn4j9JY85q3COh1dxqur/Zj+NVcwCV0Qu7
// SIG // G3MqnmDm8KWsKrFPLz5poQNIH1W+yJNWP3VaTwxsZM1x
// SIG // 1KMPfRUS5ThKrvmmvGeczdh8/b8GYroNoYICKDCCAiQG
...
// SIG // NjExWjAjBgkqhkiG9w0BCQQxFgQUrnE4/aJH1sh+cL/n
// SIG // RU1mpU3QCmIwDQYJKoZIhvcNAQEFBQAEggEAYZvpxsP8
// SIG // K+R/UrK05kXqCdWQu2EytD4xP6tUkbNtP0tw0rSCECjM
// SIG // lp+oQqlmtMyKWmrSZjVva8QtUVajsP4RckIBUzbiAqZc
// SIG // dX4XNru5X9hCxTuoX+ndP8LDJxGT6Tp8W5Ywn3zilEqr
// SIG // UhEn7MxVCAAkPawWshydJRuk/AVnJf/FdyVqU7SiwH6n
// SIG // WlLl6MKerDHFouwl6MF9jxNOYpGSStcagMHZ7ty51Ti4
// SIG // 8qC9F4rK2Fzx5LaMqQkWc8w6WyZePYDbBa3EjXQsjRxp
// SIG // tqPHkEwYF0G9yhZZV2EEw5I2CLoNpC8QApCk2VBpYAW8
// SIG // stOFrRmJtbOZsLvH5Ru0nXLIyw==
