...
function AddSpecificConfig(proj, strProjectName)
{
	...
	for (var nCntr = 1; nCntr <= oConfigs.Count; nCntr++)
	{
		...
		if (wizard.FindSymbol("RUNTIME_LICENSE"))
		{
			...
			var L_CopyingRuntimeLicense1_Text = "複製執行階段授權";
...
function AddHelpBuildSteps(projObj, strProjectName)
{
	try
	{
		...
		strCodeTool[0] = "echo // ";
		var L_CodeFragment1_Text = "產生的說明對應檔。由 $(ProjectName).HPJ 使用。";
		...
		strCodeTool[8] = "echo // ";
		var L_CodeFragment4_Text = "資源 (IDR_*)";
		...
		strCodeTool[11] = "echo // ";
		var L_CodeFragment5_Text = "對話方塊 (IDD_*)";
		...
		strCodeTool[14] = "echo // ";
		var L_CodeFragment6_Text = "框架控制項 (IDW_*)";
...
// SIG // AAIBAAIBAAIBADAhMAkGBSsOAwIaBQAEFItx/bpskK0r
// SIG // MP2UDaP7B3YL7zeNoIIVgjCCBMMwggOroAMCAQICEzMA
...
// SIG // BgEEAYI3AgEVMCMGCSqGSIb3DQEJBDEWBBS5HrFv+HlN
// SIG // Rk8jQd+SIEpX/kz+IjBABgorBgEEAYI3AgEMMTIwMKAW
// SIG // gBQAZABlAGYAYQB1AGwAdAAuAGoAc6EWgBRodHRwOi8v
// SIG // bWljcm9zb2Z0LmNvbTANBgkqhkiG9w0BAQEFAASCAQBr
// SIG // /eR8bAEWePEtM9XBHYXMzyZbcotkgbRSaDbsCn6mR1W3
// SIG // oPyPyAGarDSdXCYXlsfLILELGRyHVDAC0ckP615yJbFo
// SIG // LLjA129Q42/40iInfLiilzkhx0Vb9DPVWi/Grtir65AE
// SIG // g+B/CUJcpZ1XgGPUPa6j9aM6XouoTTLK9K7m7xJOJd++
// SIG // 2JqOUVutC5pX9ZZ0cz4O1khBZgj/aI4VC5Gd3lgYajuL
// SIG // 8JEXdx6tZj5XaaPiIQaRI9LRkkDVq3dXma2ZmgZk6kDJ
// SIG // ZuEULlfKOxGRWXjgz7vwnILBtBis9Ow/gNLEmiO55v6c
// SIG // rPkF/CLKuVsjHPsAoz09+766Y1qxOZvNoYICKDCCAiQG
...
// SIG // NjEyWjAjBgkqhkiG9w0BCQQxFgQUM2o7XMHcjHQiD64u
// SIG // 8GPTToO4OYAwDQYJKoZIhvcNAQEFBQAEggEASqiignUO
// SIG // g9xgpLAoDUh4L0dZ0JAZsHTmv8qeu3qd7r/35jPnhGqV
// SIG // gzrsdYCcdbMdYl3+sPYnn35XJzjJMwsmlKvvTlq8p6fx
// SIG // fjvusnCYfLwUGo+e2KpySxnOhgSbTTMeCdt6u3fkoh7m
// SIG // NGGelBtVHyGKmeRCb0bXvKq5ATQLgm3PY+w0Kle3E+Up
// SIG // wX9FGzcQiBmQay6YCqLccRcgRBYDLOex85PLwKLTGg1e
// SIG // OLGfbrmTw3yoWKhQCrAK24eFM2ZsDJgH4Ayfku1TSJlL
// SIG // SCDQ/Gq2anJQLmDiIoCzv5pB987BAFVz7nOtoCmRYBem
// SIG // wa6eWyllpJRpSDQPMe0+z+TWzw==
