// [!output PROPERTY_PAGE_IMPL]: Implementacja klasy strony w³aœciwoœci [!output PROPERTY_PAGE_CLASS].
...
{
[!if HELP_FILES]
	SetHelpInfo(_T("Nazwy do wyœwietlenia w formancie"), _T("[!output PROJECT_NAME].HLP"), 0);
[!endif]
}

// [!output PROPERTY_PAGE_CLASS]::DoDataExchange - Przenosi dane miêdzy stron¹ i w³aœciwoœciami
...
// Obs³ugi wiadomoœci [!output PROPERTY_PAGE_CLASS]
