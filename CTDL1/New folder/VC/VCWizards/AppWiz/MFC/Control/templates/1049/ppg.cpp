// [!output PROPERTY_PAGE_IMPL]: реализация класса страницы свойств [!output PROPERTY_PAGE_CLASS].
...
// Добавление или удаление записей системного реестра для [!output PROPERTY_PAGE_CLASS]
...
// [!output PROPERTY_PAGE_CLASS]::[!output PROPERTY_PAGE_CLASS] - Конструктор
...
{
[!if HELP_FILES]
	SetHelpInfo(_T("Имена, отображаемые в элементе управления"), _T("[!output PROJECT_NAME].HLP"), 0);
[!endif]
}

// [!output PROPERTY_PAGE_CLASS]::DoDataExchange - перенос данных между страницей и свойствами
...
// обработчики сообщений [!output PROPERTY_PAGE_CLASS]
