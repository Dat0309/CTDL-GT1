// [!output PROPERTY_PAGE_IMPL] : Implementação da classe de página de propriedades [!output PROPERTY_PAGE_CLASS].
...
{
[!if HELP_FILES]
	SetHelpInfo(_T("Nomes que aparecerão no controle"), _T("[!output PROJECT_NAME].HLP"), 0);
[!endif]
}

// [!output PROPERTY_PAGE_CLASS]::DoDataExchange - Move dados entre página e propriedades
