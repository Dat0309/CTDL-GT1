...
응용 프로그램 마법사에서 이 [!output PROJECT_NAME] DLL을 만들었습니다. 이 DLL은 MFC의 기본 사용법을 보여 줄 뿐만 아니라 DLL을 작성하기 위한 기본 구조를 제공합니다.

이 파일에는 [!output PROJECT_NAME] DLL을 구성하는 각 파일에 대한 요약 설명이 포함되어 있습니다.
...
[!output PROJECT_NAME].h
    해당 DLL의 기본 헤더 파일이며, [!output APP_CLASS] 클래스가 선언되어 있습니다.

[!output PROJECT_NAME].cpp
    기본 DLL 소스 파일입니다. [!output APP_CLASS] 클래스가 포함되어 있습니다.
[!if AUTOMATION]
    inproc 서버에 필요한 OLE 진입점도 포함되어 있습니다.
[!endif]
[!endif]
[!if AUTOMATION]

[!output SAFE_IDL_NAME].idl
    이 파일에는 DLL의 형식 라이브러리에 대한 개체 정의 언어 소스 코드가 포함되어 있습니다.
[!endif]
