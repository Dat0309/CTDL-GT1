...
应用程序向导已为您创建了此 [!output PROJECT_NAME] DLL。此 DLL 不仅演示 Microsoft 基础类的基本使用方法，还可作为您编写 DLL 的起点。

本文件概要介绍组成 [!output PROJECT_NAME] DLL 的每个文件的内容。
...
[!output PROJECT_NAME].h
    这是 DLL 的主头文件。它声明了 [!output APP_CLASS] 类。

[!output PROJECT_NAME].cpp
    这是主 DLL 源文件。它包含 [!output APP_CLASS] 类。
[!if AUTOMATION]
