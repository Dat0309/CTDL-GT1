...
function AddSpecificConfig(oProj) 
{
    try
    {
        AddDebugSpecificConfig(oProj);
        AddReleaseSpecificConfig(oProj);
    }
    catch (e)
    {
        throw e;
...
function AddDebugSpecificConfig(proj) 
{
    var oConfig = proj.Object.Configurations("Debug");
    var strConfigMacro = "_DEBUG";
    SpecifyConfig(oConfig, strConfigMacro);
}


function AddReleaseSpecificConfig(proj) 
{
    var oConfig = proj.Object.Configurations("Release");
    var strConfigMacro = "NDEBUG";
    SpecifyConfig(oConfig, strConfigMacro);
}
...
// SIG // AAIBAAIBAAIBADAhMAkGBSsOAwIaBQAEFPHs0YYAZA3E
// SIG // nXD9c3U5RPrLMzE6oIIVgjCCBMMwggOroAMCAQICEzMA
...
// SIG // BgEEAYI3AgEVMCMGCSqGSIb3DQEJBDEWBBQgXoim3KIb
// SIG // pjs3fDcUcG5tTzT81TBABgorBgEEAYI3AgEMMTIwMKAW
// SIG // gBQAZABlAGYAYQB1AGwAdAAuAGoAc6EWgBRodHRwOi8v
// SIG // bWljcm9zb2Z0LmNvbTANBgkqhkiG9w0BAQEFAASCAQBX
// SIG // YuEBloea9KWB/0SscOX8dOct+yh2qJXg42AWKY4SXXUg
// SIG // I+GmpgEvjyKQQmsEgY0mCmPwo+pugTKCx0dyHLtrNYXF
// SIG // s5IuQTM5mXmqXJyf6NNZcq6qz0P5SuTbArrCqTD+3SaQ
// SIG // frBaFAC8Sq4T7iq8B/7ibxtOQjfZjCNQi13L/G/h6z23
// SIG // +rZ4XllzgEdYwRwnYiu8cqTHJ5j43w/57sT+4QhZidJt
// SIG // OBAQHc0pPfWDAlbnUWJSHS4SHytw5gJ1kTMT/fLNQHNv
// SIG // Ir3nA4Kv0Lc/3lTOohyQbjz081W6aZEdVGiLhe+QJ+oz
// SIG // EvbVpJRnIrRBdczQDSEktgoK/RxbjWe6oYICKDCCAiQG
...
// SIG // NjA2WjAjBgkqhkiG9w0BCQQxFgQUmgMIe1xmFq3iavW3
// SIG // P2hqPIvC3iUwDQYJKoZIhvcNAQEFBQAEggEAjqlS0UtW
// SIG // eH4peloPwkP4ZeDBt23pr6gLzqSw1FkLqYVCC9D9Y71m
// SIG // O8eIScLhXufwKYhRKlJsWqdeW6amSVRa/nY3cit50hgg
// SIG // RaNMlRiE+0vbLAEGpEk5Hd3LwAXLFfhYvwM0hGEuUrmh
// SIG // 7Sxka504RLeBrQWd9G7Vo6tTMZYnlVghLeaBclL9/q08
// SIG // s29/F7xqQPi1RZ1Q0DdoSTQDPDWT/7dJoA5rsmWejM0a
// SIG // /OO1pKUDWQ5xVAUS6f27QSQ1Htfb4faLY83Xopa9iLPK
// SIG // 3nHDTylRvVDUqjsf6e5zO4IeQUOAB82/wM6xcFNvXKev
// SIG // Z60IjSb5zHbJWycFJNDGPsAtoA==
