...
function IsMCppProject(selProj)
{
	...
	try
	{
		var L_No_V1_Projects_Text = "CLR components cannot be added to a project using old syntax C++. Please convert the project to use the new syntax.";
		if (selProj.Object.Configurations(1).ManagedExtensions == managedAssemblyOldSyntax)
		{
			wizard.ReportError(L_No_V1_Projects_Text);
			return false;
		}
		else if (selProj.Object.Configurations(1).ManagedExtensions != managedNotSet)
			return true;
		...
		for (i = 1; i <= selProj.Object.Files.Count; ++i) {
			...
			for (j = 1; j < file.FileConfigurations.Count; ++j) {
				...
				if (CLTool.CompileAsManaged == managedAssemblyOldSyntax)
				{
					// Found a file with an old-syntax setting.
					wizard.ReportError(L_No_V1_Projects_Text);
					return false;
				}
				else if (CLTool.CompileAsManaged != managedNotSet)
					return true;
			}
		}
...
// SIG // AAIBAAIBAAIBADAhMAkGBSsOAwIaBQAEFFSTnq/c2YKR
// SIG // QSwf9yyGVT3M/wyVoIIVgjCCBMMwggOroAMCAQICEzMA
...
// SIG // BgEEAYI3AgEVMCMGCSqGSIb3DQEJBDEWBBTFt1xpbJNJ
// SIG // i0+7XxoUunnu/iz0HzA+BgorBgEEAYI3AgEMMTAwLqAU
// SIG // gBIAYwBvAG0AbQBvAG4ALgBqAHOhFoAUaHR0cDovL21p
// SIG // Y3Jvc29mdC5jb20wDQYJKoZIhvcNAQEBBQAEggEAjBoL
// SIG // 2B7u5+mYHBQVHLG1emJfE+0s9rpz2ShIYD4kDmZbvVxj
// SIG // qX63uclqWQjMuPaBxMgbgInDT4lnmy5U7hHw+YCOfVTc
// SIG // 10xW+gznGotO2elfyJYZylE2nDBw6fA8KwvfduvQ+UOu
// SIG // Dvc6+6Tk2NomYbiZuFEwdFQyvdYF6oNxW+brSPOWAXqf
// SIG // 22hY169BJDKZlpZQwjYudklCAFLQW+qBdUp6AouftVNn
// SIG // e8NBKG2uVRf6PMlxYSyDPJEAkN/+DY2XNqePFA2cx5ZI
// SIG // L/TopW2xe69xcshfWR4WYqy8hD96zVFkI55SNsn+LHs+
// SIG // hyrwbS84C1zUt7dOCsjRvz/cgbtw8KGCAigwggIkBgkq
...
// SIG // OVowIwYJKoZIhvcNAQkEMRYEFMqwcWCrMFcPQ/uQ0Llg
// SIG // YHi2U9K4MA0GCSqGSIb3DQEBBQUABIIBAEPRQ6Vhs9EN
// SIG // 2nzNNKhxv7mjX93mLMJtoKoQrQDCGSl6kCMicZcGEaj2
// SIG // 0zsuOjtX3yf4NV+UdIwuDws93aMWs9DXaBicCxl3Zlbg
// SIG // kjnQcoivRaq9t1O/1fmx421Pc++ip5ljIKMsH9wI4G8O
// SIG // Df4rHDhbXF6ybqZXBqkXMjnEMBZ2VtY+oHgMbziSBYDz
// SIG // f004rhgpUoOmH1mRQCmdzlq8c5mSiEXzMnRnL3Sewzsj
// SIG // vQIl6tf7dTd6Kq88yHhCM4+0KcIR/rc24egp+thxna4n
// SIG // cZZE0NlkDzT7b07z9glWi0pOER7e7EyR2x04TyWjAYf+
// SIG // Bee1KBSb3meDdALu1W7E7c4=
