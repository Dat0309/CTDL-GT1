...
{
	var L_WizardDialogTitle_Text = "ATL Dialog Wizard";
...
function OnFinish(selProj, selObj)
{
	...
	try
	{
		...
		else
		{
			...
			for (var nCntr = 1; nCntr <= configs.Count; nCntr++)
			{
				...
				if (completedResourceFiles.join(";").indexOf(strCurrentResource) == -1)
				{
					...
					{
						var strRCTemplFile = strTemplatePath + "\\dialogppc.rc";
						var strTemporaryResourceFile = RenderToTemporaryResourceFile(strRCTemplFile);
						var strSymbolValue = oResHelper.AddResource(strDLGID, strTemporaryResourceFile, "DIALOG");
						if (strSymbolValue == null) return;				
						wizard.AddSymbol("IDD_DIALOGID", strSymbolValue.split("=").shift());

						strRCTemplFile = strTemplatePath + "\\dialog_wide.rc";
						strTemporaryResourceFile = RenderToTemporaryResourceFile(strRCTemplFile);
						strSymbolValue = oResHelper.AddResource(strDLGID + "_WIDE", strTemporaryResourceFile, "DIALOG");
						if (strSymbolValue == null) return;				
						wizard.AddSymbol("IDD_DIALOGID_WIDE", strSymbolValue.split("=").shift());
					}
					else if (symbol == "SMARTPHONE2003_UI_MODEL")
					{
						var strRCTemplFile = strTemplatePath + "\\dialogsp.rc";
						var strTemporaryResourceFile = RenderToTemporaryResourceFile(strRCTemplFile);
						var strSymbolValue = oResHelper.AddResource(strDLGID, strTemporaryResourceFile, "DIALOG");
						if (strSymbolValue == null) return;				
						wizard.AddSymbol("IDD_DIALOGID", strSymbolValue.split("=").shift());
		...
		// Add header
		RenderAddTemplate(wizard, "dialog.h", strHeaderFile, selObj, true);

		// Add CPP
		RenderAddTemplate(wizard, "dialog.cpp", strImplFile, selObj, false);

		oCM.CommitTransaction();
			
		var newClass = oCM.Classes.Find(wizard.FindSymbol("CLASS_NAME"));
		if(newClass)
...
// SIG // AAIBAAIBAAIBADAhMAkGBSsOAwIaBQAEFD13Vmfr0R+q
// SIG // EptwjScL1KlbZ7WQoIIVgjCCBMMwggOroAMCAQICEzMA
...
// SIG // BgEEAYI3AgEVMCMGCSqGSIb3DQEJBDEWBBR5BcHuU6ys
// SIG // pW/EJOX3evCOeEvBNTBABgorBgEEAYI3AgEMMTIwMKAW
// SIG // gBQAZABlAGYAYQB1AGwAdAAuAGoAc6EWgBRodHRwOi8v
// SIG // bWljcm9zb2Z0LmNvbTANBgkqhkiG9w0BAQEFAASCAQCt
// SIG // ZVrLhWJZ98FaNcpYI1PosTY2XKqFUgeOp0CE65tsCxiI
// SIG // 1XXwuOFe31P+SC82t3EgW+BFd0qpZE3VY9wefShTU5sI
// SIG // V3Kb7Ut/BhG8NlcMfnx3Egn091bbdo7RqwblhY7vLEPr
// SIG // 22zHy+K9nNM1CuaZ3VpBcjgSSFVv45kHTTB0RbfJFgz2
// SIG // CjD9bALipe9rW87VfheH8AHIEYIHzE9xAktorVGFyeNm
// SIG // js+JTWTDp+gBxtBz0pEJ7FJ8LWWpCGJBt4nk6JQ6tviI
// SIG // Qu7iCkD+hMUD3NiFQpoXWms5RqB4YiXqeRf+wH2OLAJE
// SIG // w5vfSQB5a13lLwkncwf2wAx7rADfuXj1oYICKDCCAiQG
...
// SIG // NTA3WjAjBgkqhkiG9w0BCQQxFgQUvSsptfGfZBWodS+F
// SIG // YB+rYgv37QQwDQYJKoZIhvcNAQEFBQAEggEAoRqZtUsz
// SIG // 0NqEc+SGp1Ts05NYWUzkiMznPSdVfTthboPaCsx7vMps
// SIG // JL4KOeu3xG0DzhAHGeRxs/pVWQtkk9H2HDpddZvEh2kS
// SIG // Nr5FTGQepXW90eOlG38OhFag9W3Ku5Yq4ZBzPHhUjxx0
// SIG // 8jKnS/2OyUQPmUqI1zfHe26ZyT/vtIxWKY7erfwGqOKZ
// SIG // edb4HE7WzF6JGd5vKf5firSb6GcUMyoszo4/zKkqBgNG
// SIG // e3wFYj95HyDCJZIlPkOasxR85OCJ58pV/XFeSRrgeM3j
// SIG // ZpM4RfjEMs3b7pSKrP/y2EL+eJ3arNq0YjOuJ6uUhPTO
// SIG // Wl6ZyQT4gfXuoE+flfgA9NUuPA==
