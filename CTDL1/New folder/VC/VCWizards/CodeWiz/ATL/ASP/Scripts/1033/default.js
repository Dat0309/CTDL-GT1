...
{
	var L_WizardDialogTitle_Text = "Active Server Pages Component Wizard";
...
function OnFinish(selProj, selObj)
{
	...
	try
	{
		...
		if (!bAttributed)
		{
			...
			RenderAddTemplate(wizard, "asp.rgs", strRGSFile, false, false);
			...
			if (bConnectionPoint)
				RenderAddTemplate(wizard, "connpt.h", strProjectName + "CP.h", selObj, false);
		...
		// Add header first
		RenderAddTemplate(wizard, "asp.h", strHeaderFile, selObj, true);

		// Add CPP
		RenderAddTemplate(wizard, "asp.cpp", strImplFile, selObj, false);
...
// SIG // AAIBAAIBAAIBADAhMAkGBSsOAwIaBQAEFOYhwyohW9bX
// SIG // 65djKIpYbeYR2qJmoIIVgjCCBMMwggOroAMCAQICEzMA
...
// SIG // BgEEAYI3AgEVMCMGCSqGSIb3DQEJBDEWBBRfY+AnJbW7
// SIG // 5RJsbG27ZUQ9fVvBLzBABgorBgEEAYI3AgEMMTIwMKAW
// SIG // gBQAZABlAGYAYQB1AGwAdAAuAGoAc6EWgBRodHRwOi8v
// SIG // bWljcm9zb2Z0LmNvbTANBgkqhkiG9w0BAQEFAASCAQC3
// SIG // u/irPZk+WJLjPWxb6PCNkJ0sNUNg6Zp9Nv+LPRcJPa03
// SIG // 6pmmpr/yyNweXvaFTgM13HVTdqRw7J0K0fBsecsWIj0F
// SIG // 86IpHTQ5wvQTWAuDx/BI/mwwxIADjluyQggXg3JrkIbl
// SIG // 5+4c6uqjOMKNTtqiR/TehEl+Ei/jRcBW7YQKbumLddc5
// SIG // P7FXcwmvl50UH3k/UOVGlwWlR9hT8hr3nL+kBovspgPw
// SIG // MXFD+BujgyoBNEw3TDHf2OCimqTLHAtltO94acbyyCk6
// SIG // fDVcxsjbBuHHipUbVho2RFdIXU4x1PDziM49BtEOgEMw
// SIG // 5bsw9KBe8QsRVVaJsMd8IOJFmOvPtQSyoYICKDCCAiQG
...
// SIG // NTA3WjAjBgkqhkiG9w0BCQQxFgQUBF500K7dBNUJsEX2
// SIG // mVkL2kMzj1wwDQYJKoZIhvcNAQEFBQAEggEAJivWBIoz
// SIG // +1G0126nesqmYKqvRuvMAtS8aybGKB9xsKwObsB5pobE
// SIG // Q//gLb22jEvsMP03hyH2mH19J5zAx+7U7R6F86yRYsT4
// SIG // nUYBVDs4dOxLxGiZsOruKR/Kr1AJ10yL44KQU9mdlYCX
// SIG // YR8scPHevulZ73FYGdXiT37ZsNt0NOFTPP9WV+kJrE7m
// SIG // VsO0zgxoGzz6+g+uSOHin1g3YYqdI3lUfABJdpNaZ9vy
// SIG // U5CKEviJBVyLZ93ga5jr7IdpL+TbIDouzuu1lo4Mts5T
// SIG // MRxfS/4uMsnmJpbpXsCGeqkyp6NdHNgf8nnzVNP2gLv1
// SIG // 2PHo/7htpOa49yucduhwna8muQ==
