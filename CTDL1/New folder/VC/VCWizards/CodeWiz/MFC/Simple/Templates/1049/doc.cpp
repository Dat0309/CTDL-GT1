...
COleServerItem* [!output CLASS_NAME]::OnGetEmbeddedItem()
{
	...
	// Вместо возврата NULL возвращает указатель на новый производный класс COleServerItem,
	//  который используется совместно с данным документом, затем
	//  удаляет указанный ниже ASSERT(FALSE).
	//  (т. е. возвращает новый CMyServerItem.)
