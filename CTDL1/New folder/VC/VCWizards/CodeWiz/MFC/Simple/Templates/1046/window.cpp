...
#ifndef _WIN32_WCE // O Windows CE não oferece suporte a [!output BASE_CLASS].
[!endif]
...
[!if CREATABLE]
	...
	// Para manter o aplicativo em execução desde que um objeto de automação OLE 
...
void [!output CLASS_NAME]::OnFinalRelease()
{
	...
	// OnFinalRelease é chamado.  A classe base automaticamente
	// exclui o objeto.  Adicione mais limpeza necessária para seu
...
// Observação: adicionamos suporte para IID_I[!output CLASS_NAME_ROOT] para oferecer suporte à associação com segurança de tipos
