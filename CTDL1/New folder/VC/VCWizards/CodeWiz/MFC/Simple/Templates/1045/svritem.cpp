...
{
	// Wywo³ywane przez platformê, aby renderowaæ element OLE w metaplik.
	// Reprezentacja elementu OLE w postaci metapliku jest u¿ywana do wyœwietlania 
	// elementu w kontenerze aplikacji. Jeœli aplikacja kontenera by³a 
	// napisana w programie Microsoft Foundation Class Library, metaplik jest 
	// u¿ywany przez funkcjê cz³onkowsk¹ Draw odpowiadaj¹cego obiektu COleClientItem.
	// Nie ma domyœlnej implementacji. Musisz zast¹piæ tê funkcjê, aby narysowaæ
	// elementem okreœlonym do kontekstu urz¹dzenia. 
	ASSERT(FALSE);			// usuñ to po uzupe³nieniu tagów TODO
	return TRUE;
}
