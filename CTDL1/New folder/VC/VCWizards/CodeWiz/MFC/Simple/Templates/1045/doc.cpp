...
{
	// OnGetEmbeddedItem jest wywo³ywana przez framework, aby uzyskaæ COleServerItem
	//  , który jest skojarzony z dokumentem.  Jest on wywo³ywany tylko, gdy to konieczne.

	// Zamiast zwracaæ NULL, zwraca wskaŸnik do nowego COleServerItem
	//  klasy pochodnej, która jest u¿yta w po³¹czeniu z tym dokumentem, a nastêpnie
	//  usuñ ASSERT(FALSE) poni¿ej.
