...
BOOL [!output CLASS_NAME]::OnDraw(CDC* pDC, CSize& rSize)
{
	...
	// Die Metadateidarstellung des OLE-Elements wird verwendet, um das Element 
	// in der Containeranwendung anzuzeigen. Wenn die Containeranwendung mit der 
	// Microsoft Foundation Class-Bibliothek geschrieben wurde, wird die Metadatei 
	// von der Draw-Memberfunktion des entsprechenden COleClientItem-Objekts verwendet.
	// Es ist keine Standardimplementierung vorhanden. Sie müssen die Funktion überschreiben,
	// um das Element im angegebenen Gerätekontext zu zeichnen. 
