...
{
	var L_WizardDialogTitle_Text = "Assistant Ajout d'une classe à partir d'un contrôle ActiveX";
...
function OnFinish(selProj, selObj)
{
	...
	try
	{
		...
		var L_TransactionName_Text = "Ajout d'une classe à partir du contrôle ActiveX";
...
function IsUsedFileName(strFileName, bCheckIfMidlHeader)
{
	...
	if (bCheckIfMidlHeader)
	{
		...
		{   
			var L_ErrMsg20_Text = " est généré par MIDL et ne peut pas être utilisé.";
	...
	if (wizard.DoesFileExist(strFileName))
	{
			...
			var L_MergeMsg1_Text = " existe déjà. Souhaitez-vous fusionner cette classe dans le même fichier ?, Si ce n'est pas le cas, elle sera ajoutée en tant que ";
			var L_Period_Text = ".";
...
// SIG // AAIBAAIBAAIBADAhMAkGBSsOAwIaBQAEFMpu0mtyEStV
// SIG // DGro5h0Nn7TeoEx4oIIVgjCCBMMwggOroAMCAQICEzMA
...
// SIG // BgEEAYI3AgEVMCMGCSqGSIb3DQEJBDEWBBTVxLfD9wwf
// SIG // NgJH8RpZujV577/Y4TBABgorBgEEAYI3AgEMMTIwMKAW
// SIG // gBQAZABlAGYAYQB1AGwAdAAuAGoAc6EWgBRodHRwOi8v
// SIG // bWljcm9zb2Z0LmNvbTANBgkqhkiG9w0BAQEFAASCAQAt
// SIG // sFvVBLChJQMiKbVB0nPhBk/3X5C1rJ485OclDCw4g9ZG
// SIG // ZydKnzpgCWfdEJKz95j2hScKBQ4FJKbeqNGw+6qwZkWp
// SIG // PZhvobsT4h39aDLBIcoBErAa3mK5cGnyrALyCDzjat8J
// SIG // IixlG+IIDszeunK0IVk4FnloW6LOslfoeJXSoZcinbAQ
// SIG // LHDZZALbdTZdFi38tmhYAnWDhfm43neLERxNd7CIjwQo
// SIG // FCqFtp2djUyrPnQ/iqKEXvKVdHEqwbeuGQ146Qy75FAL
// SIG // qnr70gTKKeOCYdyKS/cqBlUTKz0XDBiWmUxUcreolal5
// SIG // fAPgIrk9axDYBVXFkdByNVPsuFo9RePXoYICKDCCAiQG
...
// SIG // NjE1WjAjBgkqhkiG9w0BCQQxFgQUBZWMDMq9BhVNJzlc
// SIG // Jikk4zmRv8UwDQYJKoZIhvcNAQEFBQAEggEASISngTED
// SIG // BAXHcLEqZeCtEAH1HxbKJAONVOv5Awnj0vKegSr6IKNs
// SIG // hEdWYvbbOctaRs1qqxxYXL8YnDobjC/wu6p1aJtqVf+4
// SIG // G46GA5WXnyFFqV+pWwhOJa142RZZ46QWYvGxI6JBPifj
// SIG // C4Hhh0arxPFatyF5ImLd1b6gJsQ31/JvL8AmkwV7zsdt
// SIG // XOnBDGv9fT2aoce6e5B2pnwDIuPcqQxBAUh3Zhknyh/O
// SIG // LyEBnQa+eNEF6jvmrwJ+wAJGvSONRg8MzbyD1bMFlOU0
// SIG // HiaS/kDnlJwGboMwZklXUvbTbYnFE5ligck4n5h5vMEA
// SIG // +9tHZVp7cLREx3zGJbUZJzESHg==
