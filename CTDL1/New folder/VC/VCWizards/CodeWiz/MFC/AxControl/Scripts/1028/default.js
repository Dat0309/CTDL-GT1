...
{
	var L_WizardDialogTitle_Text = "加入來自 ActiveX 控制項的類別精靈";
...
function OnFinish(selProj, selObj)
{
	...
	try
	{
		...
		var L_TransactionName_Text = "從 ActiveX 控制項加入類別";
...
function IsUsedFileName(strFileName, bCheckIfMidlHeader)
{
	...
	if (bCheckIfMidlHeader)
	{
		...
		{   
			var L_ErrMsg20_Text = " 是由 MIDL 產生，並且無法使用。";
	...
	if (wizard.DoesFileExist(strFileName))
	{
			...
			var L_MergeMsg1_Text = " 己經存在。您要將這個類別合併至相同檔案嗎? 如果不要，它將會被加入為";
			var L_Period_Text = ".";
...
// SIG // AAIBAAIBAAIBADAhMAkGBSsOAwIaBQAEFMxI68EuyFqI
// SIG // LI6gg5kEj9DpneK4oIIVgjCCBMMwggOroAMCAQICEzMA
...
// SIG // BgEEAYI3AgEVMCMGCSqGSIb3DQEJBDEWBBROCfo4n6KD
// SIG // ELthFQ8sG0L1bCEaRDBABgorBgEEAYI3AgEMMTIwMKAW
// SIG // gBQAZABlAGYAYQB1AGwAdAAuAGoAc6EWgBRodHRwOi8v
// SIG // bWljcm9zb2Z0LmNvbTANBgkqhkiG9w0BAQEFAASCAQCi
// SIG // bliPZH3+IkXSp5Ho5+xxys3oSZuAhhMmQ6tKfLZyUbEr
// SIG // 3Jm/aNMxmfFFS7EOIIUAsbamuzZYDtJ5LsqoQUz3PxLK
// SIG // xKnEUyL5Z+/qX9J8JQWhM9+zW//UmkjdhInetCucv6z0
// SIG // 6Z6NA4ymE1FhHLPzGtUIGCh7DjaWkcgF6DxK62pob3m8
// SIG // Oz0a6CoRlYYetM/Sghff9sWVBNwGXrjYcl3UMrt8jA78
// SIG // y3i1RXH3u5xp/CatRIVZR63doxOGL1daWyD3a7opOAkT
// SIG // tpNq2Cco234YWmuxtoJrugx5cBSn0t4Y5XBvQsz2zng4
// SIG // Y8UQ4sHxYapBFY41unNQbMt/6Iqh0XSwoYICKDCCAiQG
...
// SIG // NjExWjAjBgkqhkiG9w0BCQQxFgQUpcJggaht7F6NG+Ov
// SIG // fG1yTGvH4ZUwDQYJKoZIhvcNAQEFBQAEggEA3+iU6Zc8
// SIG // 5lek9fypGGw9q9vDsTmNSmjkEv6HblyLg+fJsBeb6vBj
// SIG // 1+0PJS60OSbV2fjGW5hVfcSrRSlJS8dhQWexEjjuDJNx
// SIG // ma//dSXKsRB/kd16+31DooLw/Z62bxW34oPvFtjGO3Ge
// SIG // WKnvTsXwJn5QjuyX7icCP90oBTJXoaX2EBjf8YyfkX/y
// SIG // xEoQOCelvo/ys1/5SyoZOXiBEksxe5s+75N1DiRaJrvW
// SIG // Si1DG08w8Y1pvPx6Ngu2DuKUtGb4x47OtnbYIbAGn+0a
// SIG // RROLR1Psr1HTCUh9LvaNAzBkreSMxRliRGeV7q3ttAV0
// SIG // 7vyzElxZzFBs9DmWpKsu61jg3w==
