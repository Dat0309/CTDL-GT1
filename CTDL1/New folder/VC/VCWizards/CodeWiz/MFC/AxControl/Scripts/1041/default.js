...
{
	var L_WizardDialogTitle_Text = "ActiveX コントロール クラス追加ウィザード";
...
function OnFinish(selProj, selObj)
{
	...
	try
	{
		...
		var L_TransactionName_Text = "ActiveX Control からクラスを追加";
...
function IsUsedFileName(strFileName, bCheckIfMidlHeader)
{
	...
	if (bCheckIfMidlHeader)
	{
		...
		{   
			var L_ErrMsg20_Text = " MIDL によって生成され、使用することができません。";
	...
	if (wizard.DoesFileExist(strFileName))
	{
			...
			var L_MergeMsg1_Text = " 既に存在します。このクラスを同じファイルにマージしますか? マージしない場合は、次のように追加されます。";
			var L_Period_Text = ".";
...
// SIG // AAIBAAIBAAIBADAhMAkGBSsOAwIaBQAEFDQxgwIExL+F
// SIG // LLaD5K0Wum1hNx6NoIIVgjCCBMMwggOroAMCAQICEzMA
...
// SIG // BgEEAYI3AgEVMCMGCSqGSIb3DQEJBDEWBBQEFNVcryT/
// SIG // z1PW3dg+Jh7zfyTUsjBABgorBgEEAYI3AgEMMTIwMKAW
// SIG // gBQAZABlAGYAYQB1AGwAdAAuAGoAc6EWgBRodHRwOi8v
// SIG // bWljcm9zb2Z0LmNvbTANBgkqhkiG9w0BAQEFAASCAQBY
// SIG // rtOIil841qSUD4pjwJcNDVqSwLDsh+eU1rIRRaYPKZwG
// SIG // yUddkPVvaRMXSG88uZG31LrkVEtfgSEMDD8bA7BpokDc
// SIG // vVjBUgXhshCStBXxhRBxLUefKgh0Pj2LLdK79ZTYtuFL
// SIG // KPYSzjsu2AwgNbqZ07Ve1iKbqz0/wb4qhvAK+kCvE0Wh
// SIG // Tw7pJMNav58C2MftpYStGmxEZmN6s1zqUBHtAeFRQjwI
// SIG // rQqq+g00mJ++F+qC8YCIEvR57lvaDAJsf4gtkKrqxOZU
// SIG // uFfw8tsVsxzebZkyr+dA6O3PZczOHN6FoFmhntUGEtz3
// SIG // 1SwBqIRyzs57+4vz7yXNhGIjJPHtaXZSoYICKDCCAiQG
...
// SIG // NjE5WjAjBgkqhkiG9w0BCQQxFgQUohQEC1LHSbN9ritk
// SIG // 2KqjLo2lC2swDQYJKoZIhvcNAQEFBQAEggEASZpvSEH2
// SIG // 2qoYgUr2VEVHug77q+sdf1K4YDrBR1YrIneJ+uyvselg
// SIG // RhbS6Isb+jjd0ApNqFJFv9PXVkT0T9GqN4nBugTXNMdY
// SIG // DNBghkxAkdvA24H4Kdr1DJs0vSmHv10gPkWLpANq7xlq
// SIG // 0QvExh0Wuf2gWmj86owG0+989aB+8l4rIXkXcao0AoFl
// SIG // CTd83B/UKUSRMGVNyOb0k9oiXV7Sh63Yw2cLZtc4YP42
// SIG // bzVszd75fdVd7/WfekhKN/fwU6nsrrXmIJ6c/oqaDihT
// SIG // wD5JqQD7RDfBpJJFpJRYVXZ8BTBvVd4eabwZdX7BMTn0
// SIG // ifBYMfqKt+KbSTAsgWh5ltTHjg==
