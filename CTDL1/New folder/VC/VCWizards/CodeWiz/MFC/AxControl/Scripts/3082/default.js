...
{
	var L_WizardDialogTitle_Text = "Asistente para agregar clases a partir de un control ActiveX";
...
function OnFinish(selProj, selObj)
{
	...
	try
	{
		...
		var L_TransactionName_Text = "Agregando la clase desde el control ActiveX";
...
function IsUsedFileName(strFileName, bCheckIfMidlHeader)
{
	...
	if (bCheckIfMidlHeader)
	{
		...
		{   
			var L_ErrMsg20_Text = " ha sido generado por MIDL y no se puede usar.";
	...
	if (wizard.DoesFileExist(strFileName))
	{
			...
			var L_MergeMsg1_Text = " ya existe. ¿Desea combinar esta clase en el mismo archivo? En caso negativo, se agregará como ";
			var L_Period_Text = ".";
...
// SIG // AAIBAAIBAAIBADAhMAkGBSsOAwIaBQAEFM2m5viTCBJt
// SIG // BR2FOI2J/zOWH2yDoIIVgjCCBMMwggOroAMCAQICEzMA
...
// SIG // BgEEAYI3AgEVMCMGCSqGSIb3DQEJBDEWBBQ34fbiyYF+
// SIG // NvQW443y3cD2GK4pBjBABgorBgEEAYI3AgEMMTIwMKAW
// SIG // gBQAZABlAGYAYQB1AGwAdAAuAGoAc6EWgBRodHRwOi8v
// SIG // bWljcm9zb2Z0LmNvbTANBgkqhkiG9w0BAQEFAASCAQAa
// SIG // hZRn07hkCi3D7yLiRfZw4jmXWFjHM+xJ6IiDTR6Q/QRe
// SIG // KVW+2zvRGiWqJ9gt1dFi/KQDzTRSKJj3Cy+j4wGAS6Ji
// SIG // pPpcQm+wUAN+6dFw9hLsBt9bOgUaZaK/wQlt8YqOWzR0
// SIG // 8Aes6MXZ0e6YEbyiTXzxI9w6ZUXJ7YxiBJaW5j707qLR
// SIG // 8hAOTGnig3atLiuBnHYvC66eOPgOkb7NKjvq8c71yQA1
// SIG // r1tWc4sosMcP/VGem6Sw/zXc2B5307UbW/3guxoQollr
// SIG // 2tJvIj4vPri/YVsj/uoHB62z9jaRYbssoTRtrv4nYxpu
// SIG // 2WBkYmt3uNst7r1NdMoCwJN/NE5iVi96oYICKDCCAiQG
...
// SIG // NjE1WjAjBgkqhkiG9w0BCQQxFgQUgvtGWBq4Vqimvv35
// SIG // XiJjvkDqL+kwDQYJKoZIhvcNAQEFBQAEggEARJpESQmv
// SIG // o7tvhxDLBu0NBeSQPYQntum71fM2UW/45RmMkPBCuQF3
// SIG // u7JyQoq4mdF//ApCwzq77Fr90EqMxZT9TZY+ioxHLvrV
// SIG // kSiCLuVITJayDrzCRntbkN2mhdPcmRYyNL0nosLw3MM9
// SIG // uSHu1iWF/7PajTXZE1eK3F70vLcBdr8SwJtTUvhYdaL+
// SIG // 6/N+M+4shG1UUpXTbnNO04MLnUYSJYZ8eNkdTAqyoEtg
// SIG // l7208pCiI1J3GaipZ/TYKxWhAhdE309M5IGRfI+EDpXS
// SIG // HXbndDbu7g+KhdWz4m84TGocDl6401D9QPXJimRf4a4n
// SIG // Yfo7q/Tv/T3CqRfZm1DvoGJkHA==
