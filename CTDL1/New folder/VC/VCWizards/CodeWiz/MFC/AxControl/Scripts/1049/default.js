...
{
	var L_WizardDialogTitle_Text = "Мастер добавления классов из элемента ActiveX";
...
function OnFinish(selProj, selObj)
{
	...
	try
	{
		...
		var L_TransactionName_Text = "Выполняется добавление класса из элемента управления ActiveX";
...
function IsUsedFileName(strFileName, bCheckIfMidlHeader)
{
	...
	if (bCheckIfMidlHeader)
	{
		...
		{   
			var L_ErrMsg20_Text = " создано при помощи MIDL и не может быть использовано.";
	...
	if (wizard.DoesFileExist(strFileName))
	{
			...
			var L_MergeMsg1_Text = " уже существует. Хотите добавить класс в тот же файл? Если нет, он будет добавлен как ";
			var L_Period_Text = ".";
...
// SIG // AAIBAAIBAAIBADAhMAkGBSsOAwIaBQAEFHTBSz4DbhUm
// SIG // FnCBo15NOKn32uIPoIIVgjCCBMMwggOroAMCAQICEzMA
...
// SIG // BgEEAYI3AgEVMCMGCSqGSIb3DQEJBDEWBBQt/dXTwe31
// SIG // X2u0uknHYrrrdx5esjBABgorBgEEAYI3AgEMMTIwMKAW
// SIG // gBQAZABlAGYAYQB1AGwAdAAuAGoAc6EWgBRodHRwOi8v
// SIG // bWljcm9zb2Z0LmNvbTANBgkqhkiG9w0BAQEFAASCAQAv
// SIG // 6Om0OQ7ANrPv6jemZzr50Mk56FHcy50QexWs2RxfQzkQ
// SIG // +oNpS1bsIy5Ps4tEzzCPULTFVQIhybmeKtc8UMiP0r2a
// SIG // dYzlZgUNsAVEDBtNa0Tu7LYnySaYQ/NZxvr1k+wNMJA7
// SIG // ysM6kFY9krUAstWw7NfTdZ3LTYjy7oBPt86Xuk37iRgt
// SIG // Q8rjNXuTL90uFiGuF8NF/d+0Mpflr09tIXm5YMpBWSmN
// SIG // POgdB6BMv5VpGSHrK8vT8vvXFXfSuIaZKgrUyhX1XVk2
// SIG // scUpMOGjU59mOcY6zsjIRoo+bXtNdKX2DZVClAHfmWlE
// SIG // oxTeOj1+Dc/J/Pfh/ZmuzNRqKLZ9tgEOoYICKDCCAiQG
...
// SIG // NjAzWjAjBgkqhkiG9w0BCQQxFgQUJORIBckYcU9LB2wA
// SIG // JBIOknGWjhowDQYJKoZIhvcNAQEFBQAEggEAA5TJYMKI
// SIG // nvNnWAdp2k8xwdvwVb15z1s52QCKOJ8D2N4uVx1zztr1
// SIG // DhwiWnb8Wa5tgscfzZ2eizpog1+UjVvHpP7sZa1SfvjK
// SIG // KZbDsdftRathxa7zTvE220cAYVzkmapVl2WCotptwzxL
// SIG // VwbBKymyZyfhDDIIeCEszg2H/Jh0TDi5qANUGVCn/opk
// SIG // kuyeb46fXpQFcS6iVe0hrWCmT4PAXeLmGM6pydxFRB+d
// SIG // gxLivXkTM7qvaNAu2kipXBSuOScyJJWdvqXue9jsNTYE
// SIG // CT5eCW+V3OMtDLZ/eLAT6IsqxiiCXorA1CkpdoMMvSoe
// SIG // pKyQRsIJ18FJp5ESfLOv8n7fig==
