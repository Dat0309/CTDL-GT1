...
{
	var L_WizardDialogTitle_Text = "Assistente de Adição de Classe do Controle ActiveX";
...
function OnFinish(selProj, selObj)
{
	...
	try
	{
		...
		var L_TransactionName_Text = "Adicionando Classe do Controle ActiveX";
...
function IsUsedFileName(strFileName, bCheckIfMidlHeader)
{
	...
	if (bCheckIfMidlHeader)
	{
		...
		{   
			var L_ErrMsg20_Text = " é gerado pelo MIDL e não pode ser usado.";
	...
	if (wizard.DoesFileExist(strFileName))
	{
			...
			var L_MergeMsg1_Text = " já existe. Deseja mesclar esta classe no mesmo arquivo?, Se Não, será adicionada como ";
			var L_Period_Text = ".";
...
// SIG // AAIBAAIBAAIBADAhMAkGBSsOAwIaBQAEFC4JI2AE3Zua
// SIG // TgaKLD0lnvvz06QAoIIVgjCCBMMwggOroAMCAQICEzMA
...
// SIG // BgEEAYI3AgEVMCMGCSqGSIb3DQEJBDEWBBSdOsRGFTJn
// SIG // BUG+6ZOxvPbGk3avwDBABgorBgEEAYI3AgEMMTIwMKAW
// SIG // gBQAZABlAGYAYQB1AGwAdAAuAGoAc6EWgBRodHRwOi8v
// SIG // bWljcm9zb2Z0LmNvbTANBgkqhkiG9w0BAQEFAASCAQAj
// SIG // HhavtFGGWviE/b/mt30kDP1TAqHHUIKAUrEMzqSWwdV8
// SIG // GzddL8xxMAoVJm03HFA0xL2IG6wQO77hoIDgUaRb0oi1
// SIG // SlAC8xdI2H9+/g3aUYoMWnpU3zH0nmVE7ARJ0eYE/ogo
// SIG // qPtZfNi0nNGB+RI+ETmDbJlEOShJ8MSitKVKPWNxzPij
// SIG // JHBWJrcycFD/eXUzD2pnZs1l0H96pJqG61Lr91gVZjJ6
// SIG // JhdEP7Agyh9l4lnvMpTC6dipreU4xN2oS2M8NFy/B4Q1
// SIG // ALEk7g7gzzijxPYIDfI+s0vNqlp3dA3zdUkyy7bxemUF
// SIG // u452//rh1O1BzSEc/8XEds58g3AjO7caoYICKDCCAiQG
...
// SIG // NjA0WjAjBgkqhkiG9w0BCQQxFgQUE1tBFD0EAiFlz6fc
// SIG // VkzaaJWatfAwDQYJKoZIhvcNAQEFBQAEggEAX53b3xG7
// SIG // 5ZyDKUiFt/5wIBOWdnpy7r2EbiVnEUipSU6C4pfL1oXa
// SIG // F+33zjdQggSySIn5Clhc6RxJNkuVF9k5y8L7FXetUf1B
// SIG // 64JaMby27+f7aIsAueZ43uq9PvsCiq1JCPS6Q6EgdRFy
// SIG // +zzVvaskrYRIomRGy24rjXqrIeAv2MuCtCOGhbMwFA7h
// SIG // u1917Zhni6GNPK5d29vOWTaKVunl9YV/LxIQa53IG6Vq
// SIG // X68txFrpk9xZJa6gmBMAHYT+Te1RYLyY6LtXgRGKIBTa
// SIG // 28iiVkp4EBLs5+/lmpFIu4vHL1VvYBuS6Pf08S3S1cOV
// SIG // 8PLuZ4ui4wXcowM67IrOPf8J4w==
