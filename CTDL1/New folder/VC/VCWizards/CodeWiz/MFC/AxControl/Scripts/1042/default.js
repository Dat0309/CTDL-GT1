...
{
	var L_WizardDialogTitle_Text = "ActiveX 컨트롤의 클래스 추가 마법사";
...
function OnFinish(selProj, selObj)
{
	...
	try
	{
		...
		var L_TransactionName_Text = "ActiveX 컨트롤의 클래스 추가";
...
function IsUsedFileName(strFileName, bCheckIfMidlHeader)
{
	...
	if (bCheckIfMidlHeader)
	{
		...
		{   
			var L_ErrMsg20_Text = "은(는) MIDL에서 생성되었으며 사용할 수 없습니다.";
	...
	if (wizard.DoesFileExist(strFileName))
	{
			...
			var L_MergeMsg1_Text = "이(가) 이미 있습니다. 이 클래스를 같은 파일에 병합하시겠습니까? [아니요]를 선택할 경우 ";
			var L_Period_Text = ".";
...
// SIG // AAIBAAIBAAIBADAhMAkGBSsOAwIaBQAEFGv0/uNkF+R5
// SIG // WbYUMoMKhogoP+dOoIIVgjCCBMMwggOroAMCAQICEzMA
...
// SIG // BgEEAYI3AgEVMCMGCSqGSIb3DQEJBDEWBBT4on7JTZoe
// SIG // 0AVAZe61kfz73NiwIzBABgorBgEEAYI3AgEMMTIwMKAW
// SIG // gBQAZABlAGYAYQB1AGwAdAAuAGoAc6EWgBRodHRwOi8v
// SIG // bWljcm9zb2Z0LmNvbTANBgkqhkiG9w0BAQEFAASCAQDb
// SIG // 7FRKDBWmCPvQCWoTxWBgKFaXw3JlVIA2bzgErnMbxZYW
// SIG // LiiZ+fX/ZgH+aWaBO0qaXCkElHrhCg+Sg+F2OS5NKGoo
// SIG // SrEQXzWG8mrhNVt6fOhlno1/cWk2lcNH6J6JSJVuPgQN
// SIG // x27byA7NVnsBZu9RrHWt7R4jjHh/gzsLSMWJFWN983yW
// SIG // hhiiGcQaFy8bKAQexbEOwWoOzJhfkVQ7/uHrPZFV0Hsd
// SIG // PqHfYY+ie6Af+thKMeYuS5qroC+54i1YdDsYV5DFxi3d
// SIG // Ewnjn0Frxk+Uvw4BpoJ9YgLYo/aNFcSuyemmxxZo7R0M
// SIG // Anu8qPqmZxXrDHRUXteyizJ4bp6CjmWVoYICKDCCAiQG
...
// SIG // NjAzWjAjBgkqhkiG9w0BCQQxFgQUkf3/+jHuAIvHmxe3
// SIG // EnUWNYsyssYwDQYJKoZIhvcNAQEFBQAEggEAH3nwFDuv
// SIG // 3zBgSEVm0JmEvHEMbKfZ80ghFBpQNAq8MzadlU4upLKP
// SIG // 8Tq726Jppzmx/RxBUB8wQDYEftCThBi/4nTDCm6Btb4z
// SIG // WCt3vrwaXzZyoRkvRh0DjVJ4EniYx1HZUrreuA/91W/2
// SIG // 7kTuLz+IMQ8bJAieDqRxtQcTA+/6nlL8B4KCpTXiK4wA
// SIG // ZZJrFjqEMml2PPtiMG1FfP/5n+uevkBk9hglh4xeVqew
// SIG // sR4M92A7g8ql/27slPJ/eQBbGHPQXRhTkLhpFGiLsOiN
// SIG // ZKplOcncr7aXC+ncyb3hlgOH5Uh1cPiK3yV/WjBHL2Hl
// SIG // 5X5nLurEhoXbOgF+NA/x/Gvplg==
