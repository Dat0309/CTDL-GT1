...
{
	var L_WizardDialogTitle_Text = "Aggiunta guidata classe da controllo ActiveX";
...
function OnFinish(selProj, selObj)
{
	...
	try
	{
		...
		var L_TransactionName_Text = "Aggiunta classe da controllo ActiveX";
...
function IsUsedFileName(strFileName, bCheckIfMidlHeader)
{
	...
	if (bCheckIfMidlHeader)
	{
		...
		{   
			var L_ErrMsg20_Text = " è generato da MIDL e non può essere utilizzato.";
	...
	if (wizard.DoesFileExist(strFileName))
	{
			...
			var L_MergeMsg1_Text = " esiste già. Eseguire il merge di questa classe nello stesso file? Se No, verrà aggiunto come ";
			var L_Period_Text = ".";
...
// SIG // AAIBAAIBAAIBADAhMAkGBSsOAwIaBQAEFDSuFjv9f8t4
// SIG // 3bsY4jnqIX9/DLn+oIIVgjCCBMMwggOroAMCAQICEzMA
...
// SIG // BgEEAYI3AgEVMCMGCSqGSIb3DQEJBDEWBBSWHJEAdFOZ
// SIG // bN0aQNUDXI4i9+8gozBABgorBgEEAYI3AgEMMTIwMKAW
// SIG // gBQAZABlAGYAYQB1AGwAdAAuAGoAc6EWgBRodHRwOi8v
// SIG // bWljcm9zb2Z0LmNvbTANBgkqhkiG9w0BAQEFAASCAQAo
// SIG // OlvWviPOeskPF9y4iO605DKmp+RmzJ7X7CieCdUQ/u6M
// SIG // 96m+qbts3lBIP6vzdmm4AW0+XAqOnCQ3Lx8QaqWRkKvl
// SIG // VB6+gmUM4II8MPHXTBVN3l9CDzB3IIYvItfx4Q0IWYCF
// SIG // s3bJD0nEqU05vwl/D6L98N9vOvJ2TLtX+9XDwuTMTd6a
// SIG // hfZQD8B8XXiMda2UdHk1f4+IxZEo/lO2v75wQePGS8dg
// SIG // U7N3tQ/Fgz7zBQ6YbDRmXwUFWDlq5kDCEitiDtSl1A3h
// SIG // FAQGMHq7/rHOYAse6qmpp2VMo629BQeWgb522C4GA0ph
// SIG // mvJGbByk5Z0Xd74OU+C9GOkZ2fF3cXMhoYICKDCCAiQG
...
// SIG // NjE2WjAjBgkqhkiG9w0BCQQxFgQUgXBteS15JRulFnDH
// SIG // y5DrunLgPJQwDQYJKoZIhvcNAQEFBQAEggEAiVPVMNYl
// SIG // rJU65fOnMgRXYzPQTQqFeWERtMBjh9GfbnF0b6KyDF+c
// SIG // W9lMpccHMBU+NjKCw52YNhAcdfER0F71GcgSDe5MaGDt
// SIG // V/8zzCMdaU4OTjX9G1F+Bubyu+QvIIXUOgJeQfI6XFoU
// SIG // ElfdKJcJJmzt5Bvxl99/hemV5DUGEesolmQRaQNBuuSb
// SIG // DPcbLdSVIvyq8KaR8hBmAHMpvt9Nt6Oa0/bq4d4U12m9
// SIG // ZanYlFTJF8hy+jHHjL9kq35rzp/Y6PXhNikATZNdYZdZ
// SIG // HwP+lvHX2al5Rr+QWT0MgdW8kYKTjTJiMktZllydBER7
// SIG // jltcnwdCtz/LO7ceSLlFtqAXuw==
