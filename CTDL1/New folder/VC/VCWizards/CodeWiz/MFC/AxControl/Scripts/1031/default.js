...
{
	var L_WizardDialogTitle_Text = "Assistent zum Hinzufügen von Klassen aus ActiveX-Steuerelementen";
...
function OnFinish(selProj, selObj)
{
	...
	try
	{
		...
		var L_TransactionName_Text = "Klasse aus ActiveX-Steuerelement wird eingefügt.";
...
function IsUsedFileName(strFileName, bCheckIfMidlHeader)
{
	...
	if (bCheckIfMidlHeader)
	{
		...
		{   
			var L_ErrMsg20_Text = " wird von MIDL generiert und kann nicht verwendet werden.";
	...
	if (wizard.DoesFileExist(strFileName))
	{
			...
			var L_MergeMsg1_Text = " ist bereits vorhanden. Soll diese Klasse in der gleichen Datei zusammengeführt werden? Falls nicht, wird sie hinzugefügt als ";
			var L_Period_Text = ".";
...
// SIG // AAIBAAIBAAIBADAhMAkGBSsOAwIaBQAEFIkJ6yf7763X
// SIG // 6Wcv3ZdxrQlYwIjOoIIVgjCCBMMwggOroAMCAQICEzMA
...
// SIG // BgEEAYI3AgEVMCMGCSqGSIb3DQEJBDEWBBRFpnzLZDMJ
// SIG // i+olnLWFe5vwVbebPjBABgorBgEEAYI3AgEMMTIwMKAW
// SIG // gBQAZABlAGYAYQB1AGwAdAAuAGoAc6EWgBRodHRwOi8v
// SIG // bWljcm9zb2Z0LmNvbTANBgkqhkiG9w0BAQEFAASCAQBp
// SIG // tGNuDoMLStaKi8493WkaKQnes6kzrK/uI3LXkLIrxfDb
// SIG // 1y+wrRod0Pd+TVS3VN6OeISomEWxJk+nrOcAhd1riQsD
// SIG // DiyQq6rVrQdGHGWJQZttLOFy0kEDnno5Y2kdaf8x8X6b
// SIG // HEDVRSXoGZZ33yb91EZlViKf4f5eWjWCGiGoYKLBnPJt
// SIG // ylqd7jW41RPT/PLwqgU38gGmT8LOwWudMZ5dT0ye5TQI
// SIG // pVCxR6eiWpYM5i1pRaQG8wa3vcItNqQP+4j6z0mfyBcA
// SIG // PJPiKmwGX7XdRWvlv90IuCo5fBtcuhaxgOmE7Elkr+Pd
// SIG // oRNSCJkTz2DHMjnhGQ94SD+0QY6i6PuloYICKDCCAiQG
...
// SIG // NjEwWjAjBgkqhkiG9w0BCQQxFgQU0kQtTpKVbiOIHPEW
// SIG // 0KDQzyT6mJYwDQYJKoZIhvcNAQEFBQAEggEAP9VaGwLq
// SIG // u7LhmmEoC3lRfmU2X83nLAus3OT6b7Dz3/NUknxsesBC
// SIG // DgF7YWRZT35KwHZzlspv1PxzOxtK9kNjhZmlO1lHgVGt
// SIG // vkB1DL+QHqNKc4E4g8hseXt5YeNbtI788ZipgOAoBOUA
// SIG // +BL9tzMyWXI0y30Am1ma3CNHlQKeheXhb2ztqaP/tILx
// SIG // fnuUN1eMZ4yh6axBXn5u3QoPkyZxF+2ZjLpUz9pupAUb
// SIG // fRZZJ/JlcixKcdkWPbPFCGiPycQ9mQYxc1t+nNmUTBcT
// SIG // 4sTBuE/7oexekcc8aiS/5CoIgACFgQs7aTKxAWZOU2qB
// SIG // HaLuPR9GspFP4bWJL9244kMxWw==
