...
// El asistente generó clases contenedoras IDispatch con Microsoft Visual C++
//
// Clase contenedora COleFont

class COleFont : public COleDispatchDriver
{
public:
	COleFont() {}		// Llama al constructor COleDispatchDriver predeterminado
