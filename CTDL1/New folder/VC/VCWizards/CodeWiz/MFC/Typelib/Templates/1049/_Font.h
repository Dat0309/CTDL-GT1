...
// —формированные мастером классы оболочки IDispatch, созданные при помощи Microsoft Visual C++
//
// класс-оболочка COleFont

class COleFont : public COleDispatchDriver
{
public:
	COleFont() {}		// ¬ызывает конструктор по умолчанию COleDispatchDriver
