...
// Kreator wygenerowa³ klasê(y) otoki IDispatch utworzone przez œrodowisko Microsoft Visual C++
//
// Klasa otoki COleFont

class COleFont : public COleDispatchDriver
{
public:
	COleFont() {}		// Wywo³uje konstruktor domyœlny COleDispatchDriver
